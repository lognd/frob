...
lines anymore (T-0275/T-0271 respectively), and `crates/feldspar-core/
src`'s TEST003 -- the one line that DOES still fire in that scratch
repo -- is now a case the repo's own maintainer COULD waive
successfully (the mechanism this ticket fixes), which it could not
before at all.
