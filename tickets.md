...
- op: add
  glob: tests/unit/test_memo.py
  reason: add test proving find_duplicates memoization, mirroring build_graph/analyze_project
    precedent
  actor: logan
  at: '2026-07-21'
- op: add
  glob: pyproject.toml
  reason: REL001 bump to 0.50.0 + release stamp required for the memoize_per_run docstring/decorator
    change to find_duplicates
  actor: logan
  at: '2026-07-21'
- op: add
  glob: .frob-release.json
