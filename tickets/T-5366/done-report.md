...
WEBPERF109-115 close the ticket's server/network performance-config
gap: compression, general caching headers, HTTP/2, next-gen image
formats, CDN cache hints, a server cache layer over expensive queries,
and two React render-performance shapes had no lint coverage. All
checks reuse the config-file text-regex idiom T-5325's
_websec_headers.lint_response_headers established, without importing
its private helpers (its REQUIRED_HEADERS is fixed to five security
headers, no Cache-Control/compression vocabulary). Blocks cleanly on
T-5143-2/T-5144-2/T-5148-4 per the ticket body rather than
re-implementing any of them. Kept the worktree plain (no branch
merges) so it lands without passengers, and did not touch sibling
T-5371's webperf1xx/markup/** or _webperf_markup.py. Same honest
discovery-gap disclosure as every sibling SEO/WEBPERF leaf: websec_
findings is not auto-discovered by any live gate today, covered by
T-draft-553232aa. All seven reserved ids used, no follow-up ticket
filed for an unused id this time.
...
```
 ...
 docs/modules/webapp-webperf-server.md              |   108 +
 ...
 src/frob/webapp/_webperf_server.py                 |   468 +
 ...
 .../webperf1xx/server/webperf109_negative/app.py   |     5 +
 .../server/webperf109_negative/requirements.txt    |     1 +
 .../webperf1xx/server/webperf109_positive/app.py   |     3 +
 .../server/webperf109_positive/requirements.txt    |     1 +
 .../server/webperf110_negative/nginx.conf          |     6 +
 .../server/webperf110_negative/requirements.txt    |     1 +
 .../server/webperf110_positive/nginx.conf          |     5 +
 .../server/webperf110_positive/requirements.txt    |     1 +
 .../server/webperf111_negative/nginx.conf          |     4 +
 .../server/webperf111_negative/requirements.txt    |     1 +
 .../server/webperf111_positive/nginx.conf          |     4 +
 .../server/webperf111_positive/requirements.txt    |     1 +
 .../server/webperf112_negative/page.html           |    10 +
 .../server/webperf112_negative/requirements.txt    |     1 +
 .../server/webperf112_positive/page.html           |     7 +
 .../server/webperf112_positive/requirements.txt    |     1 +
 .../server/webperf113_negative/nginx.conf          |     6 +
 .../server/webperf113_negative/requirements.txt    |     1 +
 .../server/webperf113_positive/nginx.conf          |     5 +
 .../server/webperf113_positive/requirements.txt    |     1 +
 .../server/webperf114_negative/requirements.txt    |     1 +
 .../webperf1xx/server/webperf114_negative/views.py |     7 +
 .../server/webperf114_positive/requirements.txt    |     1 +
 .../webperf1xx/server/webperf114_positive/views.py |     3 +
 .../server/webperf115_negative/SearchBox.jsx       |     6 +
 .../server/webperf115_negative/requirements.txt    |     1 +
 .../server/webperf115_positive/SearchBox.jsx       |     3 +
 .../server/webperf115_positive/requirements.txt    |     1 +
 ...
 tests/unit/test_webperf_server.py                  |    93 +
 ...
 uv.lock                                            |   265 +-
 4566 files changed, 790739 insertions(+), 23544 deletions(-)
```

### Evidence
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf109_positive-WEBPERF109-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf109_negative-WEBPERF109-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf110_positive-WEBPERF110-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf110_negative-WEBPERF110-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf111_positive-WEBPERF111-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf111_negative-WEBPERF111-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf112_positive-WEBPERF112-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf112_negative-WEBPERF112-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf113_positive-WEBPERF113-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf113_negative-WEBPERF113-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf114_positive-WEBPERF114-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf114_negative-WEBPERF114-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf115_positive-WEBPERF115-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_fixture[webperf115_negative-WEBPERF115-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_webperf_server_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_websec_findings_emits_violation_when_called_directly` (pytest node id, verified passing when recorded)
- `tests/unit/test_webperf_server.py::test_websec_findings_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
