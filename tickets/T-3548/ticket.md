---
id: T-3548
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3536):
  1 new (rule, file) identit(ies), 3 finding(s) (CLAUDE001)'
state: dropped
kind: bug
origin: agent
created: '2026-08-31'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3536) at commit 4dfb69e1b721ee95c301dfdc156c923ee1fa16dc found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
