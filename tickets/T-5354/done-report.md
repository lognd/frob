...
Randomness and TLS verification had no static coverage in the WEBSEC
family: session tokens could be seeded from a predictable PRNG, outbound
API calls could skip certificate verification or run over plaintext
http://, TLS contexts could be created with no minimum protocol version,
mobile clients could ship with no certificate pinning, and login
handlers could have no rate limiting against credential stuffing. This
closes the gap with five WARN-tier rules (WEBSEC226-230), auto-discovered
by taint_gate's existing pkgutil hook so no gate wiring was needed. HSTS
stays T-5143-2's header-lint scope, cross-referenced not duplicated.
...
```
 ...
 tests/unit/test_websec_random_tls.py               |   106 +
 ...
 uv.lock                                            |   265 +-
 4436 files changed, 764310 insertions(+), 23540 deletions(-)
```

### Evidence
- `tests/unit/test_websec_random_tls.py::test_taint_gate_discovers_websec_random_tls_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc226_positive-WEBSEC226-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc226_negative-WEBSEC226-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc227_positive-WEBSEC227-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc227_negative-WEBSEC227-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc228_positive-WEBSEC228-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc228_negative-WEBSEC228-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc229_positive-WEBSEC229-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc229_negative-WEBSEC229-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc230_positive-WEBSEC230-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_fixture[webesc230_negative-WEBSEC230-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_random_tls_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_random_tls.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
