...
Added the DOC011 catalog row -- corrected the existing but stale-attributed row (was docanchor, pre-T-2843; now docstatus with the real function reference) rather than adding a duplicate. Landed as a passenger of T-3295's discharge of T-3348's debt entry.

### Changed
(no changed files detected)

### Evidence
- `cmd:grep -n docstatus_gate docs/modules/gates.md exit=0 sha256=7a6dcd0ea762` (cmd evidence, exit=0)

### Captured claims
- tests: 0 passed (from 0 evidence id(s))
- gates: 45 error(s), 4244 warning(s), 879 waived
