...
COMPLY rules need to know two things before they can fire usefully: does
this repo's manifest imply a compliance-relevant behavior (billing, SMS,
AI on user data, a session-replay/pixel script, health data, ...), and
does the repo actually publish the privacy/terms/accessibility pages
that behavior implies it should. This ticket adds both as a pure
file-presence/content-sniff substrate, matching T-5302's detect_frameworks
shape exactly and depending on it for framework detection rather than
re-implementing it. Required-page detection is keyed off the already-
detected FrameworkKind set and returns a typani Result so a genuinely
unreadable root (not just "nothing detected") is distinguishable from an
honest empty answer. Fixtures give one positive-control repo per signal
plus a plain negative control, and present/missing pairs per router
style (file-based Next.js, config-based Flask) for required-page
detection.
...
```
 ...
 .claude/hooks/sync-claude-config.py                |   238 +-
 ...
 docs/modules/webapp-comply.md                      |    63 +
 ...
 src/frob/_cli_parsers/_ticket/_progress.py         |   229 +-
 ...
 src/frob/webapp/_comply_substrate.py               |   277 +
 ...
 .../webapp/comply1xx/pages_flask_missing/app.py    |     6 +
 .../comply1xx/pages_flask_missing/requirements.txt |     1 +
 .../webapp/comply1xx/pages_flask_present/app.py    |    14 +
 ...
 tests/fixtures/webapp/django/manage.py             |    10 +
 tests/fixtures/webapp/fastapi/main.py              |     4 +
 tests/fixtures/webapp/fastapi/requirements.txt     |     2 +
 tests/fixtures/webapp/flask/app.py                 |     4 +
 ...
 tests/test_pii_structural_gate.py                  |   154 +-
 ...
 tests/test_ticket_leases.py                        |   561 +-
 ...
 tests/test_tickets_triage_dates.py                 |    25 +-
 ...
 tests/unit/test_webapp_comply_substrate.py         |   118 +
 ...
 tests/unit/verify/test_attribution.py              |    20 +-
 ...
 tests/unit/verify/test_worker.py                   |    55 +-
 ...
 tickets/T-5305/ticket.md                           |    47 +
 tickets/T-5306/ticket.md                           |    52 +
 tickets/T-5307/ticket.md                           |    59 +
 tickets/T-5308/ticket.md                           |    52 +
 tickets/T-5309/ticket.md                           |    52 +
 tickets/T-5310/ticket.md                           |   128 +
 tickets/T-5311/ticket.md                           |   106 +
 tickets/T-5312/ticket.md                           |   508 +
 tickets/T-5313/ticket.md                           |   118 +
 ...
 tickets/T-5389/ticket.md                           |    51 +
 tickets/T-5390/ticket.md                           |    36 +
 tickets/T-5391/ticket.md                           |    37 +
 tickets/T-5392/ticket.md                           |    44 +
 tickets/T-5393/ticket.md                           |    83 +
 ...
 uv.lock                                            |     2 +-
 3988 files changed, 613756 insertions(+), 23464 deletions(-)
```

### Evidence
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_plain_is_empty` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_email-email_collection]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_ai-ai_on_user_data]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_subscriptions-subscriptions]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_data_sale-data_sale_or_share]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_sms-sms]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_session_replay-session_replay_or_pixel]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_positive_control[signal_health-health_data]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_signals_missing_root_is_empty` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_nextjs_present` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_nextjs_missing` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_flask_present` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_flask_missing` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_no_frameworks_is_empty_ok` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_comply_substrate.py::test_detect_required_pages_missing_root_is_err` (pytest node id, verified passing when recorded)
