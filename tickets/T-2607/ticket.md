---
id: T-2607
title: 'post-land sweep regression from T-2598: 1 new (rule, file) identit(ies), 0
  finding(s) (E501)'
state: queued
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2598 at commit e9ebdea193b58da277f2d60c449da979f4cd4830 found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
