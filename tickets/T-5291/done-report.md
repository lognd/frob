...
strata-core's parser gained new construct/clause keywords (export, import,
layer, accepts, as, from) that were never added to the VSCode extension's
tmLanguage grammar, so the bidirectional keyword-coverage tests failed.
Added the 6 keywords to declaration-keywords/clause-keywords in
editors/vscode-strata/syntaxes/strata.tmLanguage.json, alphabetized in
place; tests/unit/test_strata_tmlanguage.py is fully green (12/12).
...
```
 ...
 uv.lock                                            |     2 +-
 3365 files changed, 432039 insertions(+), 17076 deletions(-)
```
