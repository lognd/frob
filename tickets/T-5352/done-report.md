...
WEBSEC209-216 close the ticket's JWT/OAuth-token gap: no lint covered
jwt.decode/verify's exp/nbf/audience/issuer arguments, SimpleJWT's
refresh-token rotation+TTL config, tokens leaked via URL, or the OAuth
authorization-code flow's state/PKCE parameters. Reusing T-5308's
pkgutil discovery hook (websec_findings(root, frameworks)) keeps
taint_gate's own wiring untouched, matching every sibling WEBSEC leaf.
Fixtures live under their own websec2xx/jwt_oauth/ subdir, separate
from sibling T-5351's csrf_session/ subdir under the same parent, per
the coordinator's split. WEBSEC217 is left unimplemented (secrets-
committed is SEC001-003's job per the ticket body, no distinct check
fits the 9th reserved id) and filed as T-5496 rather than
...
```
 ...
 src/frob/webapp/_websec_tokens.py                  |   443 +
 ...
 .../jwt_oauth/webesc209_negative/manage.py         |     5 +
 .../websec2xx/jwt_oauth/webesc209_positive/auth.py |    10 +
 .../jwt_oauth/webesc209_positive/manage.py         |     5 +
 .../websec2xx/jwt_oauth/webesc210_negative/auth.py |     3 +
 .../jwt_oauth/webesc210_negative/manage.py         |     5 +
 .../websec2xx/jwt_oauth/webesc210_positive/auth.py |     3 +
 .../jwt_oauth/webesc210_positive/manage.py         |     5 +
 .../websec2xx/jwt_oauth/webesc211_negative/auth.py |     3 +
 .../jwt_oauth/webesc211_negative/manage.py         |     5 +
 .../websec2xx/jwt_oauth/webesc211_positive/auth.py |     3 +
 .../jwt_oauth/webesc211_positive/manage.py         |     5 +
 .../jwt_oauth/webesc212_negative/manage.py         |     5 +
 .../jwt_oauth/webesc212_negative/settings.py       |     6 +
 .../jwt_oauth/webesc212_positive/manage.py         |     5 +
 .../jwt_oauth/webesc212_positive/settings.py       |     6 +
 .../jwt_oauth/webesc213_negative/manage.py         |     5 +
 .../jwt_oauth/webesc213_negative/views.py          |     3 +
 .../jwt_oauth/webesc213_positive/manage.py         |     5 +
 .../jwt_oauth/webesc213_positive/views.py          |     3 +
 .../jwt_oauth/webesc214_negative/manage.py         |     5 +
 .../jwt_oauth/webesc214_negative/oauth.py          |     2 +
 .../jwt_oauth/webesc214_positive/manage.py         |     5 +
 .../jwt_oauth/webesc214_positive/oauth.py          |     2 +
 .../jwt_oauth/webesc215_negative/manage.py         |     5 +
 .../jwt_oauth/webesc215_negative/oauth_client.json |     3 +
 .../jwt_oauth/webesc215_positive/manage.py         |     5 +
 .../jwt_oauth/webesc215_positive/oauth_client.json |     3 +
 .../jwt_oauth/webesc216_negative/manage.py         |     5 +
 .../jwt_oauth/webesc216_negative/oauth.py          |     2 +
 .../jwt_oauth/webesc216_positive/manage.py         |     5 +
 ...
 uv.lock                                            |   265 +-
 4443 files changed, 764033 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc209_positive-WEBSEC209-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc209_negative-WEBSEC209-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc210_positive-WEBSEC210-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc210_negative-WEBSEC210-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc211_positive-WEBSEC211-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc211_negative-WEBSEC211-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc212_positive-WEBSEC212-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc212_negative-WEBSEC212-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc213_positive-WEBSEC213-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc213_negative-WEBSEC213-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc214_positive-WEBSEC214-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc214_negative-WEBSEC214-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc215_positive-WEBSEC215-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc215_negative-WEBSEC215-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc216_positive-WEBSEC216-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_fixture[webesc216_negative-WEBSEC216-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_token_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_tokens.py::test_taint_gate_discovers_websec_tokens_hook` (pytest node id, verified passing when recorded)
