...
## Drop reason
- 2026-08-11: T-1983: auto-dropped by the deferred post-land sweep -- every (rule, file) identity this ticket named (E501 src/frob/verify/_quarantine.py) is absent from the fresh unscoped measurement at T-2163's deferred sweep, i.e. no longer reproduces. If this is wrong (a flaky/incomplete measurement), re-file with `frob check --only <gate>` evidence attached.
