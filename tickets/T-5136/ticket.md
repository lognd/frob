...
- op: add
  ...
  reason: PERF015-018 registration ships with the detectors
  actor: logan
  at: '2026-09-21'
- op: add
  glob: docs/modules/gates.md
...
## Failure log
- 2026-09-22 attempt 1: TICK015: dead worktree (no live process holds worktree /home/logan/projects/frob/.claude/worktrees/t-5136), requeued by frob check