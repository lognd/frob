...
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-5190):
  2 new (rule, file) identit(ies) (FLAGCOV001, REL002)'
state: queued
kind: bug
origin: agent
created: '2026-09-23'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-5190) at commit 7d7e0ae4d438040e0aa6c7845b1ba7ee0d059489 found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
