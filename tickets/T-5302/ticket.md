...
- design/frob.strata
- frob.toml
- tests/unit/test_webapp_detect.py
...
scope_changes:
- op: add
  glob: tests/unit/test_webapp_detect.py
  reason: positive-control detection test and module doc need a home outside the fixture-only/design-only
    declared scope
  actor: logan
  at: '2026-09-23'
- op: add
  glob: docs/modules/webapp.md
  reason: positive-control detection test and module doc need a home outside the fixture-only/design-only
    declared scope
  actor: logan
  at: '2026-09-23'
...
anchor_reason: null
land_commit: null
worktree: /home/logan/projects/frob/.claude/worktrees/t-5302
branch: t-5302
---
