...
- 2026-08-27 attempt 2: frob refactor split ran after T-3105 landed and hit a THIRD distinct defect: import-rewrite drops leading indentation on a function-local/block-nested import, producing an unexpected-indent syntax error (confirmed at src/frob/tickets/_land.py line 3705 and 3 other files). Verify phase caught it and rolled back cleanly; no damage committed. Worktree reset clean. Filed T-draft-fe4a59c3 to fix the indentation-loss bug before retrying.
