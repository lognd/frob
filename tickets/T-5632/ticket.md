...
- src/frob/coord/_drain.py
- src/frob/coord/_hygiene.py
- tests/unit/coord/test_drain.py
- tests/unit/coord/test_hygiene.py
...
- op: add
  ...
  at: '2026-09-24'
- op: add
  glob: src/frob/coord/_drain.py
  reason: coord tree scope (COORD-TREE.md)
  actor: logan
  at: '2026-09-24'
- op: add
  glob: src/frob/coord/_hygiene.py
  reason: coord tree scope (COORD-TREE.md)
  actor: logan
  at: '2026-09-24'
- op: add
  glob: tests/unit/coord/test_drain.py
  reason: coord tree scope (COORD-TREE.md)
  actor: logan
  at: '2026-09-24'
- op: add
  glob: tests/unit/coord/test_hygiene.py
  reason: coord tree scope (COORD-TREE.md)
  actor: logan
  at: '2026-09-24'
triage_changes:
