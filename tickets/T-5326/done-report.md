...
T-5325 shipped the response-header evidence engine (lint_response_headers)
but deliberately left rule-id wiring to this ticket (its own WIRE001
waiver names T-5326 by id). Without this leaf, the WEBSEC301-309 corpus
(HSTS/CSP/nosniff/Referrer-Policy/Permissions-Policy/COOP-COEP-CORP/CORS/
Cache-Control) stayed reserved ids with no detector behind them, so
taint_gate's WEBSEC family was incomplete for the config/headers slice
of the T-5140 web-app epic. This wires all nine ids: four as a thin
wrapper over the substrate's HeaderFinding (plus HSTS max-age and CSP
nonce value checks the substrate never attempted), five as this module's
own small tracked-file text scans for headers/concerns outside the
substrate's REQUIRED_HEADERS, all auto-discovered by taint_gate's
existing pkgutil hook with no gate-file edit.
...
```
 ...
 src/frob/webapp/_websec_headers_rules.py           |   481 +
 ...
 uv.lock                                            |   265 +-
 4436 files changed, 758738 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_headers_rules.py::test_taint_gate_discovers_websec_headers_rules_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec301_positive-WEBSEC301-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec302_positive-WEBSEC302-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec303_positive-WEBSEC303-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec304_positive-WEBSEC304-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec305_positive-WEBSEC305-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec306_positive-WEBSEC306-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec307_positive-WEBSEC307-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec308_positive-WEBSEC308-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec309_positive-WEBSEC309-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec301_negative-WEBSEC301-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec302_negative-WEBSEC302-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec303_negative-WEBSEC303-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec304_negative-WEBSEC304-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec305_negative-WEBSEC305-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec306_negative-WEBSEC306-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec307_negative-WEBSEC307-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec308_negative-WEBSEC308-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_fixture[websec309_negative-WEBSEC309-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_headers_rules_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_headers_rules.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
