---
id: T-3910
title: 'post-land sweep regression from T-3886: 1 new (rule, file) identit(ies), 2
  finding(s) (DRIFT001)'
state: dropped
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-3886 at commit 7c461d3fffce13d7ed883cae1450b657e76b867f found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
