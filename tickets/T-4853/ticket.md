---
id: T-4853
title: 'migration: split module vet out of design/frob.strata into design/vet.strata
...
- text: 'Given the repository at this commit, when the strata checker runs, then it
  ...
  evidence: []
- text: Given every cross-module flow involving vet, when the linker runs, then each
  ...
  evidence: []
- text: Given the templated-assume gate, when it runs against design/vet.strata, then
