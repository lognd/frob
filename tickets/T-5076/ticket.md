...
## THIS LEAF: entity/architecture (`entity`/`architecture`/`obligation`/`binds`/`configuration`) -- _design_load.py:289,374-429. SYS300/301/302/303 are STRUCTURAL REFUSALS at parse and load time, not Datalog conclusions: a whole second type system beside the six primitives.
