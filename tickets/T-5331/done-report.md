...
CI/supply-chain hardening had no static coverage in the WEBSEC family:
secrets could leak into workflow logs, pull_request_target could run
attacker-controlled code with secrets, containers could run as root on
a drifting :latest base, and dependency manifests could drift from
their lockfiles or hide a typosquat undetected until a real incident.
This closes that gap with eight WARN-tier rules (WEBSEC318-325),
auto-discovered by taint_gate's existing pkgutil hook so no gate wiring
was needed. SHA-pinned `uses:` refs stay out of scope -- that is
T-3923's frob-vet-side VET009 extension, cross-referenced not
duplicated.
...
```
 ...
 src/frob/webapp/_websec_supply_chain.py            |   618 +
 ...
 tests/unit/test_websec_supply_chain.py             |   106 +
 ...
 uv.lock                                            |   265 +-
 4431 files changed, 759101 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_supply_chain.py::test_taint_gate_discovers_websec_supply_chain_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc318_positive-WEBSEC318-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc318_negative-WEBSEC318-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc319_positive-WEBSEC319-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc319_negative-WEBSEC319-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc320_positive-WEBSEC320-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc320_negative-WEBSEC320-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc321_positive-WEBSEC321-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc321_negative-WEBSEC321-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc322_positive-WEBSEC322-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc322_negative-WEBSEC322-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc323_positive-WEBSEC323-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc323_negative-WEBSEC323-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc324_positive-WEBSEC324-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc324_negative-WEBSEC324-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc325_positive-WEBSEC325-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_fixture[webesc325_negative-WEBSEC325-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_supply_chain_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_supply_chain.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
