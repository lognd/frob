...
Supabase RLS, webhook/payment integrations, and the LLM surface had no
static coverage in the WEBSEC family: migrated tables could ship with
no row-level security, anon keys could be granted service scope,
webhooks could accept unverified or unbounded-replay-window deliveries,
payment calls could double-charge on retry, balance/stock updates could
race, and a new agentic-LLM surface (unsafe model-output sinks,
unconfirmed write/spend tools, leaked secrets in system prompts,
unbounded completion budgets, unscoped retrieval) had no detection at
all. This closes the gap with twelve WARN-tier rules (WEBSEC408-419),
auto-discovered by taint_gate's existing pkgutil hook so no gate wiring
was needed.
...
```
 ...
 docs/modules/webapp-websec-rls-llm.md              |    98 +
 ...
 src/frob/tickets/_land_squash.py                   |   366 +-
 ...
 src/frob/webapp/_websec_rls_llm.py                 |   664 +
 ...
 .../webesc408_negative/001_create_profiles.sql     |     6 +
 .../rls_llm/webesc408_negative/requirements.txt    |     1 +
 .../webesc408_positive/001_create_profiles.sql     |     4 +
 .../rls_llm/webesc408_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc409_negative/client.py |     3 +
 .../rls_llm/webesc409_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc409_positive/client.py |     4 +
 .../rls_llm/webesc409_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc410_negative/app.py    |    13 +
 .../rls_llm/webesc410_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc410_positive/app.py    |     9 +
 .../rls_llm/webesc410_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc411_negative/app.py    |    13 +
 .../rls_llm/webesc411_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc411_positive/app.py    |    12 +
 .../rls_llm/webesc411_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc412_negative/app.py    |    10 +
 .../rls_llm/webesc412_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc412_positive/app.py    |     8 +
 .../rls_llm/webesc412_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc413_negative/app.py    |     8 +
 .../rls_llm/webesc413_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc413_positive/app.py    |     7 +
 .../rls_llm/webesc413_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc414_negative/app.py    |    10 +
 .../rls_llm/webesc414_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc414_positive/app.py    |     9 +
 .../rls_llm/webesc414_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc415_negative/app.py    |    10 +
 .../rls_llm/webesc415_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc415_positive/app.py    |    10 +
 .../rls_llm/webesc415_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc416_negative/app.py    |    10 +
 .../rls_llm/webesc416_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc416_positive/app.py    |     8 +
 .../rls_llm/webesc416_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc417_negative/app.py    |     5 +
 .../rls_llm/webesc417_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc417_positive/app.py    |     5 +
 .../rls_llm/webesc417_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc418_negative/app.py    |    10 +
 .../rls_llm/webesc418_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc418_positive/app.py    |     8 +
 .../rls_llm/webesc418_positive/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc419_negative/app.py    |     7 +
 .../rls_llm/webesc419_negative/requirements.txt    |     1 +
 .../websec4xx/rls_llm/webesc419_positive/app.py    |     7 +
 .../rls_llm/webesc419_positive/requirements.txt    |     1 +
 ...
 tests/unit/test_websec_rls_llm.py                  |   116 +
 ...
 tickets/T-5357/ticket.md                           |    96 +
 tickets/T-5358/ticket.md                           |    53 +
 tickets/T-5359/ticket.md                           |   184 +
 ...
 tickets/T-draft-a684db8f/ticket.md                 |    62 +
 ...
 uv.lock                                            |   265 +-
 4504 files changed, 770215 insertions(+), 23540 deletions(-)
```

### Evidence
- `tests/unit/test_websec_rls_llm.py::test_taint_gate_discovers_websec_rls_llm_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc408_positive-WEBSEC408-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc408_negative-WEBSEC408-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc409_positive-WEBSEC409-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc409_negative-WEBSEC409-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc410_positive-WEBSEC410-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc410_negative-WEBSEC410-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc411_positive-WEBSEC411-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc411_negative-WEBSEC411-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc412_positive-WEBSEC412-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc412_negative-WEBSEC412-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc413_positive-WEBSEC413-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc413_negative-WEBSEC413-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc414_positive-WEBSEC414-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc414_negative-WEBSEC414-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc415_positive-WEBSEC415-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc415_negative-WEBSEC415-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc416_positive-WEBSEC416-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc416_negative-WEBSEC416-False]` (pytest node id, verified passing when recorded)
...
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc417_negative-WEBSEC417-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc418_positive-WEBSEC418-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc418_negative-WEBSEC418-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc419_positive-WEBSEC419-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_fixture[webesc419_negative-WEBSEC419-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_rls_llm_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_rls_llm.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
