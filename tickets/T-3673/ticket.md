...
- tests/unit/test_conftest_console_ctrl_guard.py::TestTestConsoleCtrlIgnoreRequested::test_true_on_win32_when_truthy
- tests/unit/test_conftest_console_ctrl_guard.py::TestInstallAndUninstallTestConsoleCtrlIgnoreGuard::test_no_op_when_not_requested
- tests/unit/test_conftest_console_ctrl_guard.py::TestInstallAndUninstallTestConsoleCtrlIgnoreGuard::test_installs_and_removes_exactly_one_handler
- tests/unit/test_conftest_console_ctrl_guard.py::TestInstallAndUninstallTestConsoleCtrlIgnoreGuard::test_handler_swallows_ctrl_c_and_ctrl_break_only
