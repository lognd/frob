---
id: T-5094
title: 'migration: split module tickets out of design/frob.strata into design/tickets.strata
...
- text: 'Given the repository at this commit, when the strata checker runs, then it
  ...
  evidence: []
- text: Given every cross-module flow involving tickets, when the linker runs, then
  ...
  evidence: []
- text: Given the templated-assume gate, when it runs against design/tickets.strata,
...
there is NO a sys-split tool (rejected) tool). Write design/tickets.strata with:
