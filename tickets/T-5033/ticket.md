...
## THIS LEAF: code binding (`code`) -- _code_binding.py gives a Node a source-glob binding that kernel.md:13's Node has no attribute for; this is the entire tier-2 SYS100-103 surface
