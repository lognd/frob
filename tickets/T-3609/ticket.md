...
- old_node: tests/test_ci_workflow_matrix.py::TestWindowsDiagStepDoesNotGateTheJob::test_diag_invocation_does_not_redirect_stderr
  ...
  actor: logan
  at: '2026-09-01'
- old_node: tests/test_ci_workflow_matrix.py::TestWindowsDiagStepDoesNotGateTheJob::test_cmd_invocation_line_itself_has_no_native_pwsh_redirect
  new_node: tests/test_ci_workflow_matrix.py::TestWindowsDiagStepDoesNotGateTheJob::test_diag_invocation_uses_start_process_not_a_native_pwsh_command
  reason: T-3637 round 12 renamed this test (cmd /c invocation replaced with Start-Process);
    re-point evidence to the successor test covering the same no-native-pwsh-command
    invariant
  actor: logan
  at: '2026-09-01'
threat: null
