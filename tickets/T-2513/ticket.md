---
id: T-2513
title: 'post-land sweep regression from T-2492: 2 new (rule, file) identit(ies), 0
  finding(s) (E501, F811)'
state: dropped
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2492 at commit 785a4c81bd7f76552ef9d4cdc49e783564be6a23 found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
