...
- mode: append
  ...
  new_length: 2346
- mode: set
  reason: fix malformed multi-line frob:waive BUG002 directive (backslash continuation
    not supported in ticket-body directive parsing) -- single-line reason, no functional
    change to the waiver's justification
  actor: logan
  at: '2026-08-30'
  old_length: 2345
  new_length: 6107
