---
id: T-2043
title: 'post-land sweep regression from T-2023: 3 new (rule, file) identit(ies), 3
  finding(s) (AFFECT001, F401)'
state: dropped
kind: bug
origin: agent
created: '2026-08-10'
...
anchor_reason: null
---
The deferred post-land unscoped sweep (T-1684) for T-2023 at commit 347ec04d450e4db8d3327ccc785fe9b90e6405d6 found 3 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
...
- AFFECT001  src/frob/serve/_tools.py
...
- AFFECT001  src/frob/serve/_tools.py  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
...
## Drop reason
- 2026-08-10: T-1983: auto-dropped by the deferred post-land sweep -- every (rule, file) identity this ticket named (AFFECT001 src/frob/serve/_tools.py, F401 tests/test_gates_fmt_directives.py, F401 tests/unit/test_tickets_evidence_only_scope.py) is absent from the fresh unscoped measurement at doable's deferred sweep, i.e. no longer reproduces. If this is wrong (a flaky/incomplete measurement), re-file with `frob check --only <gate>` evidence attached.
