...
no_scope_declared_reason: 'tier=epic: decomposition container for thirteen consumer
  audit items plus the cross-cutting subject-count primitive; scope lives on the children,
  which must be filed before any code is written'
