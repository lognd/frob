...
T-4514 (Unity API capability map) landed on dev after this ticket was
filed and already removed the stale generated csharp/net excuse this
ticket describes -- both TestMatrixExhaustiveness::test_no_cell_is_
both_patterned_and_excused and test_no_unexcused_empty_cells pass
unmodified against current dev, and the full 675-test capability-
registry suite is green. No code change was needed; this ticket closes
by verifying the acceptance criterion is already satisfied.
...
```
 ...
 uv.lock                                            |     2 +-
 2815 files changed, 281138 insertions(+), 15057 deletions(-)
```

### Evidence
- `tests/test_capability_registry.py::TestMatrixExhaustiveness::test_no_cell_is_both_patterned_and_excused` (pytest node id, verified passing when recorded)
