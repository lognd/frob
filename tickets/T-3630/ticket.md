...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3624) at commit 5bb54dc5ff88d92d9eeaf13a3f6d810aa4d2453f found 4 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
...
- COV008  tests/test_gates.py
- DOC006  docs/design/check-fix-engine.md
- DOC006  docs/design/macos-portability.md
- DOC006  docs/modules/gates.md

Attribution (T-1690, symbolic reachability over the verify queue's touched-symbol sets):

- COV008  tests/test_gates.py  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
- DOC006  docs/design/check-fix-engine.md  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
- DOC006  docs/design/macos-portability.md  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
