...
CI run 35951365410 (dev) had 239 TICK008 WARNs against the real ledger,
every one naming the same two fields (branch, worktree). T-5120 stamped
these onto in-progress tickets as bare pydantic extras, on the belief that
no schema change was needed since extras round-trip fine. TICK008 (added
after T-5120) treats any extra as presumed drift, and its own real-repo
smoke test explicitly forbids calibrating around a genuinely-known field
via an allowlist, so the correct fix is to graduate branch/worktree to
real declared Ticket fields, which is what this change does. Verified
against tests/gates_suite/test_tick.py (40/40 pass, including the real-
ledger smoke test) and the T-5120 start-transition test.
...
```
 ...
 tickets/T-5463/ticket.md                           |    53 +
 tickets/T-5464/ticket.md                           |    87 +
 tickets/T-5465/ticket.md                           |    46 +
 tickets/T-5466/ticket.md                           |    50 +
 tickets/T-5467/ticket.md                           |    46 +
 ...
 tickets/T-5474/ticket.md                           |    43 +
 tickets/T-5475/ticket.md                           |    45 +
 ...
 uv.lock                                            |   265 +-
 4381 files changed, 753053 insertions(+), 23539 deletions(-)
```
