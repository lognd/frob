...
land_commit: null
---
CLUSTER leaf of T-4691 (C7). Scope-disjoint from every other cluster leaf;
...
MEASURED 2026-09-19 over src/frob/**/*.py (scratchpad/measure.py):
  21 files, 34 comment runs of 15+ consecutive `#` lines, 682 lines.

PER-FILE:
    5 runs   109 lines  src/frob/scaffold/project.py
    5 runs    87 lines  src/frob/serve/_daemon.py
    2 runs    34 lines  src/frob/process/_lock.py
    2 runs    48 lines  src/frob/process/_proc_scan.py
    2 runs    78 lines  src/frob/scaffold/_managed.py
    2 runs    39 lines  src/frob/security/_redact.py
    2 runs    32 lines  src/frob/serve/_socketd.py
    1 runs    16 lines  src/frob/perf/_redundancy.py
    1 runs    16 lines  src/frob/perf/_rules.py
    1 runs    18 lines  src/frob/process/_derived_lock.py
    1 runs    26 lines  src/frob/process/_pid_liveness.py
    1 runs    15 lines  src/frob/process/parsers/common.py
    1 runs    19 lines  src/frob/process/parsers/ruff.py
    1 runs    16 lines  src/frob/process/parsers/ty.py
    1 runs    16 lines  src/frob/refactor/_transaction.py
    1 runs    18 lines  src/frob/refactor/_verify.py
    1 runs    16 lines  src/frob/release/__init__.py
    1 runs    21 lines  src/frob/release/_cli.py
    1 runs    25 lines  src/frob/serve/_events.py
    1 runs    16 lines  src/frob/serve/_tools.py
    1 runs    17 lines  src/frob/stats/_agentic_dispatch.py
