...
### Changed
```
 docs/modules/process.md            | 28 +++++++++++++
 src/frob/process/_project_tool.py  | 82 ++++++++++++++++++++++++++++++++++++--
 tests/unit/test_project_tool.py    | 56 ++++++++++++++++++++++++++
 tickets/T-4354/ticket.md           |  5 +++
 tickets/T-4358/ticket.md | 63 +++++++++++++++++++++++++++++
 5 files changed, 231 insertions(+), 3 deletions(-)
```

### Evidence
- `tests/unit/test_project_tool.py::TestToolAbsent::test_true_on_spawn_failure` (pytest node id, verified passing when recorded)
- `tests/unit/test_project_tool.py::TestToolAbsent::test_false_unrelated_exit` (pytest node id, verified passing when recorded)
- `tests/unit/test_project_tool.py::TestToolAbsent::test_false_wrong_tool` (pytest node id, verified passing when recorded)
- `tests/unit/test_project_tool.py::TestResolveProjectTool::test_absent_err` (pytest node id, verified passing when recorded)

### Captured claims
- tests: 4 passed (from 4 evidence id(s))
- gates: 0 error(s), 4757 warning(s), 958 waived
