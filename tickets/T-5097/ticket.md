---
id: T-5097
title: 'migration: split module platform out of design/frob.strata into design/platform.strata
...
- text: 'Given the repository at this commit, when the strata checker runs, then it
  ...
  evidence: []
- text: Given every cross-module flow involving platform, when the linker runs, then
  ...
  evidence: []
- text: Given the templated-assume gate, when it runs against design/platform.strata,
...
there is NO a sys-split tool (rejected) tool). Write design/platform.strata with:
