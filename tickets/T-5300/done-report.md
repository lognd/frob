...
WEBSEC/A11Y/SEO web-app lint rules in the T-5140 epic cannot run against
.html/.js/.jsx/.vue files until frob.lang.parse_file stops returning
UnsupportedLanguage for those four extensions -- this is the shared
substrate leaf every downstream WEBSUB/WEBSEC story blocks on.
Confirmed via a throwaway get_parser() call that tree-sitter-language-pack
already bundles html/javascript/vue grammars, then wired thin walkers
(mirroring _walk_css.py's/_walk_typescript.py's shape) into the existing
_EXTENSION_TABLE/_WALKERS/COMMENT_TYPES dispatch tables, serialized behind
T-5303's concurrent lease on the same shared file (src/frob/lang/__init__.py).
Positive-control fixtures plus a dedicated test file confirm parse_file/
raw_tree/symbol_tree now succeed for all four extensions.
...
```
 ...
 docs/design/registry/check-coverage.yaml           |   207 +-
 ...
 src/frob/gates/__init__.py                         |   737 +-
 ...
 tickets/T-5380/ticket.md                           |    72 +
 tickets/T-5381/ticket.md                           |    45 +
 tickets/T-5382/ticket.md                           |    44 +
 tickets/T-5383/ticket.md                           |    44 +
 tickets/T-5384/ticket.md                           |    45 +
 tickets/T-5385/ticket.md                           |    49 +
 tickets/T-5386/ticket.md                           |    36 +
 tickets/T-draft-c0e05ddc/ticket.md                 |    36 +
 ...
 uv.lock                                            |     2 +-
 3926 files changed, 574525 insertions(+), 23425 deletions(-)
```

### Evidence
- `tests/test_lang_html_js_jsx_vue.py::TestHtml::test_html_is_a_supported_language` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestHtml::test_parse_html_sample` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestHtml::test_positive_control_raw_tree_is_non_empty` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestHtml::test_top_level_element_is_a_class_symbol` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestJsx::test_jsx_is_a_supported_extension` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestJsx::test_parse_jsx_sample` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestJsx::test_positive_control_raw_tree_is_non_empty` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestJsx::test_exported_function_is_a_public_function_symbol` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestVue::test_vue_is_a_supported_language` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestVue::test_parse_vue_sample` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestVue::test_positive_control_raw_tree_is_non_empty` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestVue::test_template_block_is_a_class_symbol` (pytest node id, verified passing when recorded)
- `tests/test_lang_html_js_jsx_vue.py::TestVue::test_sfc_shell_has_exactly_three_blocks` (pytest node id, verified passing when recorded)
