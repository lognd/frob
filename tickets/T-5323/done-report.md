...
A11Y101-115 close the non-text-content/structure/form-labeling third of
the T-5146 WCAG 2.2 corpus over T-5313's tree-query substrate. A11Y is
this family's first live gate: frob.gates._a11y_gate discovers every
frob.webapp._a11y_* module's a11y_findings hook via pkgutil so a future
A11Y rule chunk needs zero gate edits (closes "catalogued is not
enforced" per SUBSTRATE-FANOUT lessons -- WIRE001 on the substrate now
clears since the gate genuinely consumes it). Also fixed T-5422's
post-land residue on _a11y_substrate.py (COV001/DOC002/DUP001/DUP002/
PERF002/REF002, plus REF002 on webapp-a11y.md): per-symbol doc anchors
replaced the prose-only sections DOC002 couldn't resolve, the html/jsx
attribute-extraction near-clone collapsed into one grammar-parameterized
helper, and an O(n) .index() in heading_sequence's loop became an O(1)
dict lookup built once at import time.
...
```
 ...
 docs/modules/webapp-a11y-structure.md              |   107 +
 ...
 src/frob/app/ticket_runner/_lifecycle.py           |   463 +-
 ...
 src/frob/gates/_a11y_gate.py                       |   164 +
 ...
 src/frob/tickets/_reconcile.py                     |    91 +-
 ...
 src/frob/webapp/_a11y_substrate.py                 |   396 +
 ...
 tests/test_ticket_reconcile.py                     |   273 +-
 ...
 tests/unit/test_webapp_a11y_structure.py           |   140 +
 ...
 tickets/T-5321/ticket.md                           |   142 +
 tickets/T-5322/ticket.md                           |   150 +
 tickets/T-5323/ticket.md                           |   187 +
 tickets/T-5324/ticket.md                           |   130 +
 ...
 uv.lock                                            |     2 +-
 4135 files changed, 672974 insertions(+), 23504 deletions(-)
```

### Evidence
- `tests/unit/test_webapp_a11y_structure.py::test_a11y101_missing_alt` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y102_svg_missing_name` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y103_skipped_heading_level` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y104_duplicate_h1` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y105_missing_title` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y106_missing_lang` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y107_empty_lang` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y108_link_no_name` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y109_button_no_name` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y110_generic_link_text` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y111_unlabeled_input` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y112_missing_autocomplete` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y113_duplicate_id` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y114_invalid_role` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_a11y115_invalid_aria_attribute` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_structure.py::test_no_framework_short_circuits_to_empty` (pytest node id, verified passing when recorded)
