...
WEBSEC218-224 close the ticket's password-policy/storage gap: no lint
covered missing email-verification/breach-password checks, weak
MD5/SHA1 password hashing, AES-ECB, hardcoded IVs, default seed-data
accounts, or case-folded password comparisons. Reusing T-5308's pkgutil
discovery hook (websec_findings(root, frameworks)) keeps taint_gate's
own wiring untouched, matching every sibling WEBSEC leaf. T-5352 was
still queued, not landed, so its token helpers were not imported from;
no helper was needed here regardless (file-scope regex checks only).
Fixtures live under their own websec2xx/password/ subdir, separate from
sibling T-5351's csrf_session/ and T-5352's jwt_oauth/ subdirs under
the same parent. WEBSEC225 is left unimplemented (the ticket body's
seven-item corpus fits seven of the eight reserved ids) and filed as
T-5500 rather than expanding this ticket's scope.
...
```
 ...
 tickets/T-draft-8e22a4c8/ticket.md                 |    39 +
 tickets/T-draft-9fadcc07/ticket.md                 |    38 +
 tickets/T-draft-a684db8f/ticket.md                 |    39 +
 ...
 uv.lock                                            |   265 +-
 4443 files changed, 764323 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc218_positive-WEBSEC218-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc218_negative-WEBSEC218-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc219_positive-WEBSEC219-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc219_negative-WEBSEC219-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc220_positive-WEBSEC220-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc220_negative-WEBSEC220-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc221_positive-WEBSEC221-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc221_negative-WEBSEC221-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc222_positive-WEBSEC222-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc222_negative-WEBSEC222-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc223_positive-WEBSEC223-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc223_negative-WEBSEC223-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc224_positive-WEBSEC224-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_fixture[webesc224_negative-WEBSEC224-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_password_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_password.py::test_taint_gate_discovers_websec_password_hook` (pytest node id, verified passing when recorded)
