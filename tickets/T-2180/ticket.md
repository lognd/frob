...
- old_node: tests/unit/test_coordinator_scripts.py::TestLandInvocations::test_rows_with_no_ticket_id_are_never_merged_together
  ...
  actor: logan
  at: '2026-08-16'
- old_node: tests/unit/test_coordinator_scripts.py::TestPrintLandStatus::test_prints_stale_lock_when_no_live_holder
  new_node: tests/unit/test_coordinator_scripts.py::TestPrintLandStatus::test_prints_no_live_holder_as_normal_resting_state_not_stale
  reason: T-2249 fold-in renamed this test to match the corrected LAND LOCK wording
    (idle/no-live-holder now reads as normal resting state, not stale); same assertion
    coverage, new name
  actor: logan
  at: '2026-08-17'
threat: null
