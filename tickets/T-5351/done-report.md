...
CSRF and session lifecycle had no static coverage in the WEBSEC family:
GET routes could mutate state and bypass CSRF, session validity could be
checked client-side only, logins could skip session-id rotation and
logouts could leave sessions valid server-side, and cookies could ship
with no SameSite/CSRF middleware/idle/absolute timeout configured. This
closes that gap with eight WARN-tier rules (WEBSEC201-208), four handler-
shape text scans and four built directly on T-5349's normalized
SessionConfig reader (no re-parsing). Account-enumeration-via-error-text
has no id left in this reservation and is filed as follow-up.
...
```
 ...
 docs/modules/webapp-websec-csrf-session.md         |   110 +
 ...
 src/frob/webapp/_websec_csrf_session.py            |   482 +
 ...
 .../csrf_session/webesc201_negative/app.py         |     8 +
 .../webesc201_negative/requirements.txt            |     1 +
 .../csrf_session/webesc201_positive/app.py         |     9 +
 .../webesc201_positive/requirements.txt            |     1 +
 .../csrf_session/webesc202_negative/app.py         |     9 +
 .../webesc202_negative/requirements.txt            |     2 +
 .../csrf_session/webesc202_positive/app.py         |     7 +
 .../webesc202_positive/requirements.txt            |     1 +
 .../csrf_session/webesc203_negative/app.py         |     9 +
 .../webesc203_negative/requirements.txt            |     2 +
 .../csrf_session/webesc203_positive/app.py         |     8 +
 .../webesc203_positive/requirements.txt            |     2 +
 .../csrf_session/webesc204_negative/app.py         |    12 +
 .../webesc204_negative/requirements.txt            |     1 +
 .../csrf_session/webesc204_positive/app.py         |    10 +
 .../webesc204_positive/requirements.txt            |     1 +
 .../csrf_session/webesc205_negative/app.py         |     9 +
 .../webesc205_negative/requirements.txt            |     1 +
 .../csrf_session/webesc205_positive/app.py         |     8 +
 .../webesc205_positive/requirements.txt            |     1 +
 .../csrf_session/webesc206_negative/app.py         |     9 +
 .../webesc206_negative/requirements.txt            |     2 +
 .../csrf_session/webesc206_positive/manage.py      |     3 +
 .../csrf_session/webesc206_positive/settings.py    |     8 +
 .../csrf_session/webesc207_negative/manage.py      |     3 +
 .../csrf_session/webesc207_negative/settings.py    |     8 +
 .../csrf_session/webesc207_positive/app.py         |     9 +
 .../webesc207_positive/requirements.txt            |     2 +
 .../csrf_session/webesc208_negative/app.py         |     8 +
 .../webesc208_negative/requirements.txt            |     1 +
 .../csrf_session/webesc208_positive/app.py         |     7 +
 .../webesc208_positive/requirements.txt            |     1 +
 ...
 tests/unit/test_websec_csrf_session.py             |   112 +
 ...
 tickets/T-5465/ticket.md                           |    55 +
 tickets/T-5466/ticket.md                           |    50 +
 tickets/T-5467/ticket.md                           |    64 +
 tickets/T-5468/ticket.md                           |    47 +
 tickets/T-5469/ticket.md                           |    49 +
 tickets/T-5470/ticket.md                           |    52 +
 ...
 uv.lock                                            |   265 +-
 4442 files changed, 764050 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_csrf_session.py::test_taint_gate_discovers_websec_csrf_session_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc201_positive-WEBSEC201-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc201_negative-WEBSEC201-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc202_positive-WEBSEC202-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc202_negative-WEBSEC202-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc203_positive-WEBSEC203-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc203_negative-WEBSEC203-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc204_positive-WEBSEC204-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc204_negative-WEBSEC204-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc205_positive-WEBSEC205-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc205_negative-WEBSEC205-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc206_positive-WEBSEC206-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc206_negative-WEBSEC206-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc207_positive-WEBSEC207-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc207_negative-WEBSEC207-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc208_positive-WEBSEC208-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_fixture[webesc208_negative-WEBSEC208-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_csrf_session_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_csrf_session.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
