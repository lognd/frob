...
WEBSEC310-316 close the ticket's debug/info-leak-config gap: prod
configuration that discloses internal state (DEBUG=True, shipped
source maps, verbose stack traces, directory listing, .git deployed,
public buckets, secrets in a front-end bundle) had no lint coverage in
the WEBSEC family. Reusing T-5308's pkgutil discovery hook (a plain
websec_findings(root, frameworks) module function) keeps taint_gate's
own wiring untouched, matching every sibling WEBSEC leaf's convention.
WEBSEC317 is left unimplemented (only 7 of the reserved 8 ids fit a
distinct check; default-creds is SEC001-003's job per the ticket body)
and WEBSEC316's secret table is a small local copy pending T-5141 --
both filed as T-5490 rather than expanding this ticket's scope.
...
```
 ...
 .../websec3xx/debug/webesc310_negative/manage.py   |     5 +
 .../websec3xx/debug/webesc310_negative/settings.py |     3 +
 .../websec3xx/debug/webesc310_positive/manage.py   |     5 +
 .../websec3xx/debug/webesc310_positive/settings.py |     1 +
 .../debug/webesc311_map_negative/manage.py         |     5 +
 .../debug/webesc311_map_negative/static/main.js    |     1 +
 .../debug/webesc311_map_positive/manage.py         |     5 +
 .../webesc311_map_positive/static/main.js.map      |     1 +
 .../websec3xx/debug/webesc311_negative/manage.py   |     5 +
 .../debug/webesc311_negative/webpack.config.js     |     3 +
 .../websec3xx/debug/webesc311_positive/manage.py   |     5 +
 .../debug/webesc311_positive/webpack.config.js     |     3 +
 .../websec3xx/debug/webesc312_negative/app.py      |     4 +
 .../websec3xx/debug/webesc312_negative/manage.py   |     5 +
 .../websec3xx/debug/webesc312_positive/app.py      |     4 +
 .../websec3xx/debug/webesc312_positive/manage.py   |     5 +
 .../websec3xx/debug/webesc313_negative/manage.py   |     5 +
 .../websec3xx/debug/webesc313_negative/nginx.conf  |     5 +
 .../websec3xx/debug/webesc313_positive/manage.py   |     5 +
 ...
 .../websec3xx/debug/webesc314_negative/manage.py   |     5 +
 .../websec3xx/debug/webesc314_positive/Dockerfile  |     3 +
 .../websec3xx/debug/webesc314_positive/manage.py   |     5 +
 .../websec3xx/debug/webesc315_negative/main.tf     |     4 +
 .../websec3xx/debug/webesc315_negative/manage.py   |     5 +
 .../websec3xx/debug/webesc315_positive/main.tf     |     4 +
 .../websec3xx/debug/webesc315_positive/manage.py   |     5 +
 .../websec3xx/debug/webesc316_negative/manage.py   |     5 +
 .../debug/webesc316_negative/static/main.js        |     2 +
 .../websec3xx/debug/webesc316_positive/manage.py   |     5 +
 ...
 tests/unit/test_websec_debug_config.py             |   118 +
 ...
 uv.lock                                            |   265 +-
 4436 files changed, 758999 insertions(+), 23539 deletions(-)
```

### Evidence
- `tests/unit/test_websec_debug_config.py::test_taint_gate_discovers_websec_debug_config_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc310_positive-WEBSEC310-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc310_negative-WEBSEC310-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc311_positive-WEBSEC311-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc311_negative-WEBSEC311-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc312_positive-WEBSEC312-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc312_negative-WEBSEC312-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc313_positive-WEBSEC313-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc313_negative-WEBSEC313-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc314_positive-WEBSEC314-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc314_negative-WEBSEC314-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc315_positive-WEBSEC315-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc315_negative-WEBSEC315-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc316_positive-WEBSEC316-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_fixture[webesc316_negative-WEBSEC316-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_map_file_variant` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_debug_config_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_findings_discovery_hook_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_debug_config.py::test_websec_findings_discovery_hook_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
