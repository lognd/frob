...
land_commit: null
---
Add an evidence-running channel that invokes 'dotnet test' for plain C# projects and documents/parses the Unity batchmode runner ('Unity -batchmode -runTests -testResults <path>') XML results into frob's evidence model. blocked_by T-draft-e360b04f (node ids must exist before evidence can bind results to them).
