...
## Drop reason
- 2026-08-08: refiling with the BUG002 waiver reason in the ticket body from the start (this ticket's checker only reads ticket.body, not the Done report) -- absorbed-by the refiled draft
