---
id: T-3779
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3778):
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3778) at commit 65f91521a5ff1e63c4244de80345992991fc50b5 found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
