...
evidence_changes:
- old_node: tests/test_gates.py::TestInv006Gate::test_ratchet_fresh_finding_errors_when_rule_enabled
  new_node: tests/test_gates_ratchet.py::TestResolveRatchetSeverity::test_fresh_finding_errors
  reason: T-1763 deleted INV006, the first (and now only-historical) rule ratcheting
    was wired into; rebinding to the still-live generic ratchet-mechanism test
  actor: logan
  at: '2026-08-07'
- old_node: tests/test_gates.py::TestInv006Gate::test_ratchet_baselined_finding_stays_warn
  new_node: tests/test_gates_ratchet.py::TestResolveRatchetSeverity::test_baselined_finding_stays_warn
  reason: T-1763 deleted INV006; rebinding to the still-live generic ratchet-mechanism
    test
  actor: logan
  at: '2026-08-07'
- old_node: tests/test_gates.py::TestInv006Gate::test_ratchet_rule_not_enabled_stays_static_warn
  new_node: tests/test_gates_ratchet.py::TestResolveRatchetSeverity::test_unratcheted_rule_with_no_pool_is_error
  reason: T-1763 deleted INV006; rebinding to the closest still-live generic ratchet-mechanism
    test (unratcheted-rule behavior)
  actor: logan
  at: '2026-08-07'
- old_node: tests/test_gates.py::TestInv006Gate::test_this_repos_frob_toml_and_ratchet_lock_calibrate
  new_node: tests/test_gates_ratchet.py::TestRatchetEnabledRules::test_reads_configured_rules
  reason: T-1763 deleted INV006, whose own frob.toml/ratchet-lock calibration this
    test verified; rebinding to the closest still-live generic ratchet-config-read
    test (this repo's own [gates.ratchet] rules list is now empty per T-1763)
  actor: logan
  at: '2026-08-07'
threat: null
component: null
