---
id: T-3547
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3493):
  1 new (rule, file) identit(ies) (DOC011)'
state: dropped
kind: bug
origin: agent
created: '2026-08-31'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3493) at commit 4b566117b4049574f15ca2a303ba26168413dbba found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
