...
## Drop reason
- 2026-09-12: attempt 1 measured the premise wrong on the mirror (platform_skipped is intact there); the runner-only persistence is re-filed as T-4449 with the CI-order reproduction plan, and the severity-override half landed as T-4447 (absorbed by T-4449)
