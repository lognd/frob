---
id: T-2592
title: 'post-land sweep regression from T-2197: 43 new (rule, file) identit(ies),
  44 finding(s) (ARCH103, COV001, COV003, COV004)'
state: dropped
kind: bug
origin: agent
created: '2026-08-19'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2197 at commit bfa7803ff6d1f4050f18eb7f30d0846618a4c688 found 43 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.

T-1935: this is a count of DISTINCT (rule, file) IDENTITIES (43), not a raw finding count -- every finding sharing a (rule, file) pair collapses into ONE identity here (deliberately, so attribution and quarantine reason about "which files went red", not individual diagnostics). An independent re-measurement found 44 actual finding(s) across those 43 identit(ies).
...
- E501  src/frob/scaffold/project.py
...
- ARCH103  src/frob/tickets/_store.py  -> attributed to T-2197 (commit 696659925a62, already closed/dropped -- filed below) via src/frob/tickets/_draft_finalize.py::_commit_and_warn_promote -> src/frob/tickets/_draft_finalize.py::_promote_commit_pathspecs -> src/frob/tickets/_store.py::_store_mode
...
- E501  src/frob/app/ticket_runner/_ledger_mirror.py  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
...
- E501  src/frob/scaffold/project.py  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
...
## Drop reason
- 2026-08-19: DUPLICATE-WITH-A-NAMED-SURVIVOR, NOT a false positive. All 40 live identities in this tickets 43-item list were confirmed already tracked in T-2653 (union computed against T-2653s own normalized identity list). The remaining 3 (E501 on _ledger_mirror.py/_verify.py/scaffold/project.py) were independently re-measured and confirmed NOT reproducing on current main (E501 is absent repo-wide right now, only I001 exists) so were correctly excluded from T-2653s tracked set rather than carried forward. This tickets real findings survive in T-2653; do not read this drop as evidence they were bogus. (absorbed by T-2653)
