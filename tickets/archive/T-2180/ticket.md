...
evidence:
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandInvocations::test_collapses_process_fan_out_by_ticket_id
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandInvocations::test_rows_with_no_ticket_id_are_dropped_not_reported
- tests/unit/coordinator_suite/test_fleet_land.py::TestPrintLandStatus::test_prints_invocations_and_live_lock_holder
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandLockHolderPids::test_finds_a_pid_holding_the_lock_open
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandLockHolderPids::test_no_live_holder_returns_empty
...
- tests/unit/coordinator_suite/test_fleet_worktrees.py::TestScopeIntersections::test_reports_overlapping_pair
- tests/unit/coordinator_suite/test_fleet_worktrees.py::TestScopeIntersections::test_no_overlap_reports_empty
- tests/unit/coordinator_suite/test_fleet_worktrees.py::TestScopeIntersections::test_checks_against_a_held_lease_outside_the_requested_set
...
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestHostLoad::test_missing_proc_files_return_none
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandProcessRows::test_parses_matching_rows_and_skips_others
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandProcessRows::test_failed_ps_returns_empty
- tests/unit/coordinator_suite/test_fleet_land.py::TestLandInvocations::test_must_pass_control_one_land_many_processes_reports_one
...
- text: The wave check must live in the standing report a coordinator ALREADY runs,
  ...
  - tests/unit/coordinator_suite/test_fleet_report.py::TestPrintFleetReport::test_prints_all_four_sections
evidence_changes:
- old_node: tests/unit/coordinator_suite/test_fleet_land.py::TestLandInvocations::test_rows_with_no_ticket_id_are_never_merged_together
  new_node: tests/unit/coordinator_suite/test_fleet_land.py::TestLandInvocations::test_rows_with_no_ticket_id_are_dropped_not_reported
  ...
  actor: logan
  at: '2026-08-16'
- old_node: tests/unit/coordinator_suite/test_fleet_land.py::TestPrintLandStatus::test_prints_stale_lock_when_no_live_holder
  new_node: tests/unit/coordinator_suite/test_fleet_land.py::TestPrintLandStatus::test_prints_no_live_holder_as_normal_resting_state_not_stale
