---
id: T-1644
title: Bind src/frob/yamlio.py into the strata self-model and waive INV006 on the
  T-1420 TS split
state: done
kind: docs
origin: human
...
- cmd:grep -c 'src/frob/yamlio.py' design/frob.strata exit=0 sha256=4355a46b19d3
