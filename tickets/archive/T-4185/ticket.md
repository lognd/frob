...
## Drop reason
- 2026-09-19: duplicate: the zero-match via-glob finding already ships as SYS113 (T-4110), wired into SELFAUDIT001 via check_self_conformance and documented in docs/modules/gates.md; verified live by the T-4185 investigator 2026-09-19 (see worktree t-4185 branch note) (absorbed by T-4110)
