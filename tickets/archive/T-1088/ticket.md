...
- tests/vet_suite/test_supply_chain.py::TestSupplyChainUnpinnedDependencies::test_pyproject_exact_pin_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainUnpinnedDependencies::test_package_json_wildcard_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainUnpinnedDependencies::test_cargo_toml_caret_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainInstallArtifacts::test_setup_py_absolute_data_files_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainInstallArtifacts::test_setup_py_traversal_data_files_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainInstallArtifacts::test_setup_py_package_relative_data_files_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainInstallArtifacts::test_no_setup_py_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainCiActionPin::test_workflow_branch_ref_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainCiActionPin::test_workflow_full_sha_ref_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainCiActionPin::test_no_workflows_dir_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainOpaqueBinaryArtifact::test_tracked_so_without_recipe_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainOpaqueBinaryArtifact::test_so_with_nearby_cargo_toml_not_flagged
- tests/vet_suite/test_supply_chain.py::TestSupplyChainOpaqueBinaryArtifact::test_no_binary_files_not_flagged
