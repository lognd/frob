---
id: T-2652
title: 'post-land sweep regression from T-2624: 1 new (rule, file) identit(ies), 1
  finding(s) (F401)'
state: dropped
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2624 at commit 3e3c127342d0cba99eeaaec2f69b5b233beb1cdc found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
