...
Filed: this is child batch 1 of T-2359 (the parent reformat epic-tracking
ticket, still open pending further batches).

Gates: scoped `frob check --ticket T-2773` (lint/scope/PRE/
COV002/TODO001/FMT/AFFECT for this batch) clean on the touched files.
This closes only this 15-file child batch; T-2359 itself remains open
until every batch lands and its own repo-wide acceptance criteria can
honestly bind.

### Changed
```
 tickets/T-2359/done-report.md      |  97 +++++++++++++++++++++
 tickets/T-2359/ticket.md           | 172 ++++++++++++++++++++++++++++++++++++-
 tickets/T-2773/ticket.md | 151 ++++++++++++++++++++++++++++++++
...
- gates: 19 error(s), 1406 warning(s), 711 waived
