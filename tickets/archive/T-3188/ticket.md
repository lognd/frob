...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-2616) at commit 915eff3fdfa55eedd0cf5cb27186e0310bff446a found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
...
- DOC006  tickets/T-3180/ticket.md
- REF002  .claude-scratch/T-3122-close-guard-repro-capture.md

Attribution (T-1690, symbolic reachability over the verify queue's touched-symbol sets):

- DOC006  tickets/T-3180/ticket.md  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
