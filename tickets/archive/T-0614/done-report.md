...
### Evidence
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_is_a_language_adapter` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_imports` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_class_bases_fields_and_methods` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_data_class_constructor_properties` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_sealed_class_with_no_body` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_override_modifier` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_function_params_and_return_type` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_branches_loops_calls_field_accesses` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_method_chain_does_not_confuse_calls_with_field_accesses` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_when_entries_are_branches_and_loop_kinds` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_throw_and_catch` (pytest node id, verified passing when recorded)
- `tests/unit/arch_suite/test_lang_adapters.py::TestKotlinAdapter::test_adapt_stays_sane_on_realistic_snippet` (pytest node id, verified passing when recorded)
