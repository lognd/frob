...
- mode: append
  ...
  new_length: 707
evidence:
- cmd:python3 -c "import sys,pathlib;from frob.gates._markdown_scan import strip_code_spans
  as s;ok='T-2736' not in s(pathlib.Path('docs/modules/tickets-verify-sweep.md').read_text());print('DOC011
  clean:', ok);sys.exit(0 if ok else 1)" exit=0 sha256=f1cfe2567fd3
kind_history:
