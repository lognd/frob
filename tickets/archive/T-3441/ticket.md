...
anchor: false
anchor_reason: null
land_commit: 845432ee77306446ffec956c32d8a32759c1c793
---
The deferred post-land unscoped sweep (T-1684) for T-3296 at commit 89278e4046ce56b0e1645176c632334e0eee8937 found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
...
- COV001  src/frob/tickets/_scope.py
- DRIFT001  src/frob/tickets/_scope.py

Attribution (T-1690, symbolic reachability over the verify queue's touched-symbol sets):

- COV001  src/frob/tickets/_scope.py  -> attributed to T-3296 (commit 89278e4046ce, already closed/dropped -- filed below) via src/frob/tickets/_scope.py::FROB_MANAGED_SIDE_EFFECT_PATHS
