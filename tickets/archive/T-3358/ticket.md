...
## Drop reason
- 2026-08-29: stranded in-progress with no worktree; identical title and premise to T-3360, which landed the fix at 983851e92 (skip_stale_claims threaded through _done_transition_guard for reverify_close_guard only). The lingering in-progress state held a lease on docs/modules/tickets.md that blocked Series EO's DOC011 fix. (absorbed by T-3360)
