...
- op: add
  ...
  at: '2026-08-21'
evidence:
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestOrphanedForkserverCount::test_two_level_chain_with_dead_root_is_orphaned
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestOrphanedForkserverCount::test_deep_chain_under_a_live_check_is_not_orphaned
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestOrphanedForkserverCount::test_zero_forkservers_reports_zero
...
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestDeriveForkserverStaleAfterS::test_derives_from_recorded_samples_with_headroom
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestDeriveForkserverStaleAfterS::test_missing_samples_file_falls_back
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestDeriveForkserverStaleAfterS::test_malformed_samples_file_falls_back
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestDeriveForkserverStaleAfterS::test_thin_samples_never_derive_below_the_floor
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestForkserverContradictionLine::test_fires_on_zero_zero_high_swap
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestForkserverContradictionLine::test_silent_when_swap_below_pressure_floor
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestForkserverContradictionLine::test_silent_when_orphaned_or_stale_nonzero
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestForkserverContradictionLine::test_silent_on_any_unknown_input
- tests/unit/coordinator_suite/test_fleet_host_load.py::TestConcurrentCheckCount::test_counts_check_processes
designated_repro_test: tests/unit/coordinator_suite/test_fleet_host_load.py::TestOrphanedForkserverCount::test_two_level_chain_with_dead_root_is_orphaned
threat: null
component: null
anchor: false
anchor_reason: null
land_commit: 95959c78419df7f6e1aebb83be941a1e2a5c91ed
---
## Measured 2026-08-21
