---
id: T-2594
title: 'post-land sweep regression from T-2582: 34 new (rule, file) identit(ies),
  42 finding(s) (ARCH103, COV001, COV003, COV004)'
state: dropped
kind: bug
origin: agent
created: '2026-08-19'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2582 at commit 62007fc8d8e1e0e93511234884ba5ff2a12448e2 found 34 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.

T-1935: this is a count of DISTINCT (rule, file) IDENTITIES (34), not a raw finding count -- every finding sharing a (rule, file) pair collapses into ONE identity here (deliberately, so attribution and quarantine reason about "which files went red", not individual diagnostics). An independent re-measurement found 42 actual finding(s) across those 34 identit(ies).
...
- DOC006  tickets/T-2585/ticket.md
...
- ARCH103  src/frob/tickets/_store.py  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
...
- DOC006  tickets/T-2585/ticket.md  -> UNATTRIBUTED (no batch commit's touched symbols reach this finding); candidate commits: []
...
## Drop reason
- 2026-08-19: DUPLICATE-WITH-A-NAMED-SURVIVOR, NOT a false positive. All live identities in this ticket were confirmed already tracked in T-2653 (union computed against T-2653s own normalized identity list). The two identities present here but not in T-2653 (E501 on _ledger_mirror.py/scaffold/project.py, and DOC006 on tickets/T-2585/ticket.md) were independently re-measured and confirmed NOT reproducing on current main (E501 is absent repo-wide, only I001 exists; DOC006s only current finding is tickets/T-2570/ticket.md, already tracked) so were correctly excluded rather than carried forward. This tickets real findings survive in T-2653; do not read this drop as evidence they were bogus. (absorbed by T-2653)
