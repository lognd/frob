...
evidence:
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_simple_assignment_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_chained_assignment_outer_target_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_chained_assignment_inner_target_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_array_destructure_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_default_param_forwarding_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_member_rebind_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_closure_capture_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_reassigned_alias_call_via_chained_target_still_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_default_param_benign_not_detected
- tests/vet_suite/test_capability_scan_ts.py::TestCapabilityScanTsTaxonomyClosureResolution::test_member_rebind_benign_not_detected
