...
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_walk_python_imports_skips_unparseable_files
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_resolve_import_registry_match
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_resolve_import_registry_match_via_pypi_name_override
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_resolve_import_no_capability_match
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_resolve_import_vetted_via_local_source_scan_and_cache
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_resolve_import_unknown_when_unresolvable
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_closed_world_accounting_source_unavailable
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_closed_world_accounting_full_pass
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_closed_world_accounting_closed_when_no_unknowns
- tests/vet_suite/test_opaque_indirection.py::TestClosedWorldAccounting::test_import_resolution_model_fields
