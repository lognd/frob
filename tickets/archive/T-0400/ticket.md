...
- op: add
  ...
  at: '2026-07-21'
evidence:
- tests/vet_suite/test_capability_scan_python.py::TestCapabilityScan::test_c_source_fs_write_detected
- tests/vet_suite/test_capability_scan_python.py::TestCapabilityScan::test_c_source_raw_fd_read_detected
- tests/vet_suite/test_capability_scan_python.py::TestCapabilityScan::test_c_source_windows_exec_detected
- tests/vet_suite/test_capability_scan_python.py::TestCapabilityScan::test_c_source_net_recv_detected
- tests/vet_suite/test_fingerprint.py::TestFingerprintScan::test_whitespace_reformatted_needle_still_matches
- tests/vet_suite/test_fingerprint.py::TestFingerprintScan::test_whitespace_tolerant_match_still_respects_comment_spans
- tests/vet_suite/test_scan_tree.py::TestScanTreeSourceUnavailableFailClosed::test_missing_source_surfaces_error_violation
- tests/vet_suite/test_scan_tree.py::TestScanTreeSourceUnavailableFailClosed::test_enforced_missing_source_fails_the_gate
- tests/vet_suite/test_scan_tree.py::TestScanTreeMultipleLockfiles::test_scan_tree_scans_every_lockfile
- tests/vet_suite/test_lockfile.py::TestLockfileParsers::test_find_all_lockfiles_polyglot_repo
- tests/vet_suite/test_lockfile.py::TestLockfileParsers::test_find_all_lockfiles_single
- tests/vet_suite/test_lockfile.py::TestLockfileParsers::test_find_all_lockfiles_none
- tests/vet_suite/test_lockfile.py::TestLockfileParsers::test_find_all_lockfiles_direct_path
...
- tests/vet_suite/test_fingerprint.py::TestObfuscationEnsemble::test_split_string_payload_still_not_detected
