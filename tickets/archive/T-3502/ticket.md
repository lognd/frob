---
id: T-3502
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3489):
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3489) at commit 6b4a146f6aadd4d07fe0272efce2d637e480f0d3 found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
