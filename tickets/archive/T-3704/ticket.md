---
id: T-3704
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3700):
  1 new (rule, file) identit(ies), 1 finding(s) (TICK003)'
state: dropped
kind: bug
origin: agent
created: '2026-09-02'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3700) at commit 0920df5788e6038076bba0943c4c73762e5832c0 found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
