...
GIVEN the fixture's NUnit and [UnityTest] tests, WHEN test evidence collection runs (T-draft-e360b04f/T-draft-44634f20), THEN both are collected and bindable, proving stories 1-5 compose end to end.