---
id: T-4870
title: 'migration: split module deploy out of design/frob.strata into design/deploy.strata
...
- text: 'Given the repository at this commit, when the strata checker runs, then it
  ...
  evidence: []
- text: Given every cross-module flow involving deploy, when the linker runs, then
  ...
  evidence: []
- text: Given the templated-assume gate, when it runs against design/deploy.strata,
...
there is NO frob sys split tool). Write design/deploy.strata with:
