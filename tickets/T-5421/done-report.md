...
T-5300/T-5303 added css/scss/html/javascript/vue to
frob.lang._extract.COMMENT_TYPES without updating
docs/guides/extending/comment-dsl-directives.md's frob:enumerates
directive, which DOCENUM001 (and this file's own targeted unit test)
cross-checks against the live dict. Added the 5 missing languages to
the members= list and the surrounding prose (twelve -> seventeen
walkers).
...
```
 ...
 tickets/T-draft-0006b3a1/ticket.md                 |    43 +
 ...
 uv.lock                                            |     2 +-
 3977 files changed, 621737 insertions(+), 23479 deletions(-)
```
