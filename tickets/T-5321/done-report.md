...
Adds the A11Y116-124 keyboard/focus/target-size/motion leaf of the T-5140
web-app A11Y epic, wired into T-5323's real per-file a11y_findings(ctx,
frameworks) gate-discovery contract. Root cause of the post-merge land
failure: a sibling hook module (frob.webapp._a11y_statement, T-5324)
still used the pre-T-5323 (root, frameworks) shape and crashes
a11y_gate() unconditionally for any repo with any detected framework --
unrelated to this leaf's own code, filed as T-5448 (outside
this ticket's scope). This leaf's own gate-wiring test now exercises the
gate's real private hook-discovery helper plus a direct call of the
discovered hook (the same parse/ctx shape a11y_gate itself uses)
instead of a full a11y_gate() scan, so it proves discovery and firing
without depending on an unrelated, currently-broken sibling.
...
```
 ...
 tickets/T-5321/done-report.md                      |  4277 ++++
 tickets/T-5321/ticket.md                           |   176 +
 ...
 uv.lock                                            |     2 +-
 4296 files changed, 726811 insertions(+), 23508 deletions(-)
```

### Evidence
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y116_positive-A11Y116-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y116_negative-A11Y116-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y117_positive-A11Y117-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y117_negative-A11Y117-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y118_positive-A11Y118-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y118_negative-A11Y118-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y119_positive-A11Y119-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y119_negative-A11Y119-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y120_positive-A11Y120-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y120_negative-A11Y120-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y121_positive-A11Y121-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y121_negative-A11Y121-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y122_positive-A11Y122-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y122_negative-A11Y122-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y123_positive-A11Y123-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y123_negative-A11Y123-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y124_positive-A11Y124-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_findings_fixture[a11y124_negative-A11Y124-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_interaction_positive_control_returns_correct_rule` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_gate_discovers_a11y_interaction_hook` (pytest node id, verified passing when recorded)
- `tests/unit/test_webapp_a11y_interaction.py::test_a11y_gate_discovered_hook_fires_on_planted_violation` (pytest node id, verified passing when recorded)
