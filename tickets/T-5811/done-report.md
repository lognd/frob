...
CI run 36086669322 failed "Typecheck" on all three platforms (ubuntu/
macos/windows) with identical unresolved-import errors for sqlfluff.
Root-caused from the raw job logs: CI's initial "Sync deps" step runs
uv sync --all-extras --all-groups (installs sqlfluff, confirmed by the
log's own + sqlfluff line), but a later "make core-wheels" step reaches
$(STAMP): pyproject.toml's own uv sync --extra serve recipe via the
core-wheels -> core -> $(STAMP) dependency chain -- this re-narrows the
sync, uninstalling sqlfluff (confirmed by the log's own - sqlfluff line
immediately after "uv sync --extra serve") before the Typecheck step
ever runs. Because Typecheck fails, every downstream Test step is
skipped on all three platforms. Added --extra sql to the stamp's
recipe (excluding --extra smt deliberately, per the comment above the
rule: z3-solver can fail to build on some hosts, sqlfluff carries no
such risk). Verified directly: re-ran the exact CI sequence (uv sync
--all-extras --all-groups, then make core) locally -- sqlfluff stays
installed, ty check on src/frob/sql/_sqlfluff_plugin.py passes. Added a
regression test (matching T-4479's own precedent shape: parse the
Makefile recipe text and assert its extras) that genuinely fails at dev
...
```
 ...
 changelog.d/T-5352.md                              |     2 +
 changelog.d/T-5353.md                              |     2 +
 changelog.d/T-5354.md                              |     2 +
 ...
 docs/modules/webapp-websec-jwt-oauth.md            |    94 +
 docs/modules/webapp-websec-password.md             |   101 +
 docs/modules/webapp-websec-random-tls.md           |   103 +
 ...
 .../data/shared/python/logging/config.toml.j2      |    20 +-
 .../data/shared/python/logging/logger.py.j2        |    13 +
 .../shared/python/logging/stream_handler.py.j2     |    56 +
 ...
 .../python-tool/tests/unit/test_logging.py.j2      |    33 +
 ...
 src/frob/scaffold/project.py                       |    34 +-
 ...
 src/frob/webapp/_websec_password.py                |   441 +
 src/frob/webapp/_websec_random_tls.py              |   410 +
 ...
 src/frob/webapp/_websec_tokens.py                  |   439 +
 ...
 .../websec2xx/jwt_oauth/webesc209_negative/auth.py |     3 +
 .../jwt_oauth/webesc209_negative/manage.py         |     6 +
 .../websec2xx/jwt_oauth/webesc209_positive/auth.py |    10 +
 .../jwt_oauth/webesc209_positive/manage.py         |     6 +
 .../websec2xx/jwt_oauth/webesc210_negative/auth.py |     3 +
 .../jwt_oauth/webesc210_negative/manage.py         |     6 +
 .../websec2xx/jwt_oauth/webesc210_positive/auth.py |     3 +
 .../jwt_oauth/webesc210_positive/manage.py         |     6 +
 .../websec2xx/jwt_oauth/webesc211_negative/auth.py |     3 +
 .../jwt_oauth/webesc211_negative/manage.py         |     6 +
 .../websec2xx/jwt_oauth/webesc211_positive/auth.py |     3 +
 .../jwt_oauth/webesc211_positive/manage.py         |     6 +
 .../jwt_oauth/webesc212_negative/manage.py         |     6 +
 .../jwt_oauth/webesc212_negative/settings.py       |     6 +
 .../jwt_oauth/webesc212_positive/manage.py         |     6 +
 .../jwt_oauth/webesc212_positive/settings.py       |     6 +
 .../jwt_oauth/webesc213_negative/manage.py         |     6 +
 .../jwt_oauth/webesc213_negative/views.py          |     3 +
 .../jwt_oauth/webesc213_positive/manage.py         |     6 +
 .../jwt_oauth/webesc213_positive/views.py          |     3 +
 .../jwt_oauth/webesc214_negative/manage.py         |     6 +
 .../jwt_oauth/webesc214_negative/oauth.py          |     2 +
 .../jwt_oauth/webesc214_positive/manage.py         |     6 +
 .../jwt_oauth/webesc214_positive/oauth.py          |     2 +
 .../jwt_oauth/webesc215_negative/manage.py         |     6 +
 .../jwt_oauth/webesc215_negative/oauth_client.json |     3 +
 .../jwt_oauth/webesc215_positive/manage.py         |     6 +
 .../jwt_oauth/webesc215_positive/oauth_client.json |     3 +
 .../jwt_oauth/webesc216_negative/manage.py         |     6 +
 .../jwt_oauth/webesc216_negative/oauth.py          |     2 +
 .../jwt_oauth/webesc216_positive/manage.py         |     6 +
 .../jwt_oauth/webesc216_positive/oauth.py          |     2 +
 .../password/webesc218_negative/manage.py          |     6 +
 .../websec2xx/password/webesc218_negative/views.py |     5 +
 .../password/webesc218_positive/manage.py          |     6 +
 .../websec2xx/password/webesc218_positive/views.py |     3 +
 .../password/webesc219_negative/manage.py          |     6 +
 .../websec2xx/password/webesc219_negative/views.py |     5 +
 .../password/webesc219_positive/manage.py          |     6 +
 .../websec2xx/password/webesc219_positive/views.py |     3 +
 .../websec2xx/password/webesc220_negative/auth.py  |     5 +
 .../password/webesc220_negative/manage.py          |     6 +
 .../websec2xx/password/webesc220_positive/auth.py  |     5 +
 .../password/webesc220_positive/manage.py          |     6 +
 .../password/webesc221_negative/crypto.py          |     3 +
 .../password/webesc221_negative/manage.py          |     6 +
 .../password/webesc221_positive/crypto.py          |     3 +
 .../password/webesc221_positive/manage.py          |     6 +
 .../password/webesc222_negative/crypto.py          |     4 +
 .../password/webesc222_negative/manage.py          |     6 +
 .../password/webesc222_positive/crypto.py          |     2 +
 .../password/webesc222_positive/manage.py          |     6 +
 .../password/webesc223_negative/manage.py          |     6 +
 .../webesc223_negative/seed/create_admin.py        |     5 +
 .../password/webesc223_positive/manage.py          |     6 +
 .../webesc223_positive/seed/create_admin.py        |     2 +
 .../websec2xx/password/webesc224_negative/auth.py  |     2 +
 .../password/webesc224_negative/manage.py          |     6 +
 .../websec2xx/password/webesc224_positive/auth.py  |     2 +
 .../password/webesc224_positive/manage.py          |     6 +
 ...
 .../websec2xx/random_tls/webesc226_negative/app.py |     9 +
 .../random_tls/webesc226_negative/requirements.txt |     1 +
 .../websec2xx/random_tls/webesc226_positive/app.py |     9 +
 .../random_tls/webesc226_positive/requirements.txt |     1 +
 .../websec2xx/random_tls/webesc227_negative/app.py |     8 +
 .../random_tls/webesc227_negative/requirements.txt |     2 +
 .../websec2xx/random_tls/webesc227_positive/app.py |     8 +
 .../random_tls/webesc227_positive/requirements.txt |     2 +
 .../websec2xx/random_tls/webesc228_negative/app.py |     7 +
 .../random_tls/webesc228_negative/requirements.txt |     1 +
 .../websec2xx/random_tls/webesc228_positive/app.py |     6 +
 .../random_tls/webesc228_positive/requirements.txt |     1 +
 .../webesc229_negative/NetworkClient.swift         |     4 +
 .../websec2xx/random_tls/webesc229_negative/app.py |     3 +
 .../random_tls/webesc229_negative/requirements.txt |     1 +
 .../webesc229_positive/NetworkClient.swift         |     3 +
 .../websec2xx/random_tls/webesc229_positive/app.py |     3 +
 .../random_tls/webesc229_positive/requirements.txt |     1 +
 .../websec2xx/random_tls/webesc230_negative/app.py |     9 +
 .../random_tls/webesc230_negative/requirements.txt |     2 +
 .../websec2xx/random_tls/webesc230_positive/app.py |     7 +
 .../random_tls/webesc230_positive/requirements.txt |     1 +
 ...
 tests/system/test_scaffold_dx.py                   |    15 +-
 ...
 tests/test_ci_workflow_core_wheels.py              |    49 +
 ...
 tests/unit/test_websec_password.py                 |   107 +
 tests/unit/test_websec_random_tls.py               |   108 +
 tests/unit/test_websec_sinks.py                    |    93 +
 tests/unit/test_websec_supply_chain.py             |   109 +
 tests/unit/test_websec_tokens.py                   |   110 +
 ...
 tickets/T-5352/done-report.md                      |  4484 ++++
 tickets/T-5352/ticket.md                           |   116 +
 tickets/T-5353/done-report.md                      |  4483 ++++
 tickets/T-5353/ticket.md                           |   133 +
 tickets/T-5354/done-report.md                      |  4468 ++++
 tickets/T-5354/ticket.md                           |   126 +
 ...
 tickets/T-5466/done-report.md                      |  4443 ++++
 ...
 tickets/T-5755/ticket.md                           |    60 +
 tickets/T-5756/ticket.md                           |    61 +
 tickets/T-5757/ticket.md                           |    60 +
 tickets/T-5758/ticket.md                           |    60 +
 tickets/T-5759/ticket.md                           |    42 +
 tickets/T-5760/ticket.md                           |    80 +
 tickets/T-5761/ticket.md                           |    85 +
 tickets/T-5762/ticket.md                           |    74 +
 tickets/T-5763/ticket.md                           |    63 +
 tickets/T-5764/ticket.md                           |    85 +
 tickets/T-5765/ticket.md                           |    79 +
 tickets/T-5766/ticket.md                           |    56 +
 tickets/T-5767/ticket.md                           |    81 +
 tickets/T-5768/ticket.md                           |    80 +
 tickets/T-5769/ticket.md                           |    52 +
 tickets/T-5770/ticket.md                           |    60 +
 tickets/T-5771/ticket.md                           |    72 +
 tickets/T-5772/ticket.md                           |    58 +
 tickets/T-5774/ticket.md                           |    73 +
 tickets/T-5775/ticket.md                           |    59 +
 tickets/T-5776/ticket.md                           |    59 +
 tickets/T-5780/ticket.md                           |    66 +
 tickets/T-5784/ticket.md                           |   124 +
 tickets/T-5785/ticket.md                           |    81 +
 tickets/T-5786/ticket.md                           |    83 +
 tickets/T-5791/ticket.md                           |    64 +
 tickets/T-5797/ticket.md                           |    56 +
 tickets/T-5798/ticket.md                           |    95 +
 tickets/T-5805/ticket.md                           |   124 +
 tickets/T-5807/ticket.md                           |    61 +
 tickets/T-5808/ticket.md                           |    56 +
 tickets/T-5811/ticket.md                           |    94 +
 tickets/T-5812/ticket.md                           |    63 +
 tickets/T-draft-0ab8e38c/ticket.md                 |    72 +
 tickets/T-draft-16f22785/ticket.md                 |    69 +
 tickets/T-draft-42b1e188/ticket.md                 |    65 +
 tickets/T-draft-4626b5d7/ticket.md                 |    72 +
 tickets/T-draft-60cd980e/ticket.md                 |    68 +
 tickets/T-draft-cbdee0d3/ticket.md                 |   103 +
 tickets/T-draft-d52705da/ticket.md                 |    51 +
 tickets/T-draft-e6027ecc/ticket.md                 |    52 +
 ...
 uv.lock                                            |   265 +-
 4838 files changed, 907178 insertions(+), 23581 deletions(-)
```

### Evidence
- `tests/test_ci_workflow_core_wheels.py::TestInstallStampSyncsSqlExtra::test_recipe_syncs_sql_extra` (pytest node id, verified passing when recorded)
- `tests/test_ci_workflow_core_wheels.py::TestInstallStampSyncsSqlExtra::test_recipe_does_not_sync_smt_extra` (pytest node id, verified passing when recorded)
