---
id: T-2546
title: 'post-land sweep regression from T-2527: 1 new (rule, file) identit(ies), 1
  finding(s) (E501)'
state: queued
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2527 at commit a9dd9c55682b295a6f0b2f70ea43578594c92cac found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
