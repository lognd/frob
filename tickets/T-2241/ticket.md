...
- text: 'GIVEN the Makefile WHEN read THEN sync-skills: is a single ''uv run frob
  ...
  - tests/unit/test_skills_sync.py::TestMakefileRecipeDelegates::test_recipe_body_is_a_single_line
evidence_changes:
- old_node: tests/unit/test_skills_sync.py::TestSyncSkills::test_removes_stale_claude_side_entry
  new_node: tests/unit/test_skills_sync.py::TestSyncSkills::test_removes_stale_claude_side_entry_this_repo_previously_installed
  reason: T-2386 renamed this test to reflect the provenance-aware semantics (removal
    now restricted to entries THIS repo's manifest previously installed) -- same coverage
    shape, same assertions, new name
  actor: logan
  at: '2026-08-18'
threat: null
component: null
