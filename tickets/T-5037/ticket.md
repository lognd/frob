...
## THIS LEAF: capability via-lists (`may`/`via`/`of`/`exclusive`) -- _effects.py; kernel.md:13 lists the `may` set but the via-list and exclusivity are NOT in the kernel at all, and SYS111's ratchet reads them directly
