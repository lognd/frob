...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2389 at commit 4c3973f24f7b1489a8bf48f7299d8ae6415b9dfd found 35 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.

T-1935: this is a count of DISTINCT (rule, file) IDENTITIES (35), not a raw finding count -- every finding sharing a (rule, file) pair collapses into ONE identity here (deliberately, so attribution and quarantine reason about "which files went red", not individual diagnostics). An independent re-measurement found 73 actual finding(s) across those 35 identit(ies).
