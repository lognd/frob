...
Token spend was only ever recorded manually (T-5132's `frob ticket
tokens`), never automatically, so most landed tickets carry no usage
data at all. Added Ticket.usage: TicketUsage | None
(frob.tickets._token_usage), mined at zero model cost from Claude Code
transcript JSONL: dispatch-telemetry.py's SessionStart hook now also
records transcript_path alongside the session_id/worktree it already
wrote to .frob/telemetry.jsonl (reused rather than a second sessions
file), and collect_ticket_usage sums input/output/cache token fields
across every session inside the ticket's lease window, streaming each
transcript from a cached byte offset (.frob/token-usage-cache.json) so
re-collection only reads new bytes, capped at 2s wall-clock per call.
Wired through frob.tickets._leases.release_lease -- the one chokepoint
transition() already runs through on every terminal IN_PROGRESS exit
(close or land), best-effort so a collection failure never blocks the
transition. None means human-worked/unmeasured and is never coerced to
a zeroed TicketUsage. HarnessAdapter is the seam a second harness would
implement; only ClaudeCodeAdapter exists today.
...
```
 ...
 .../registry/capability-via-ratchet.lock.json      |   131 +-
 docs/design/registry/check-coverage.yaml           |   202 +-
 ...
 src/frob/_cli_parsers/_ops.py                      |    67 +-
 ...
 src/frob/_cli_parsers/_status.py                   |     2 -
 src/frob/_cli_parsers/_ticket/__init__.py          |    70 +-
 .../_cli_parsers/_ticket/_closeout_evidence.py     |    24 +
 src/frob/_cli_parsers/_ticket/_metadata.py         |   151 +-
 src/frob/_cli_parsers/_ticket/_new.py              |    56 +-
 ...
 src/frob/app/ticket_runner/_attach_backfill.py     |     2 -
 ...
 src/frob/app/ticket_runner/_lifecycle.py           |   433 +-
 ...
 src/frob/findings.py                               |    29 +-
 src/frob/fleet/__init__.py                         |    24 -
 src/frob/gates/__init__.py                         |   581 +-
 ...
 src/frob/gates/_guard_closure.py                   |   294 +
 src/frob/gates/_inv.py                             |   645 +
 src/frob/gates/_land_format.py                     |     3 -
 src/frob/gates/_land_parity.py                     |    97 +-
 src/frob/gates/_lang_conformance.py                |   203 +-
 ...
 src/frob/gates/_pii_structural/__init__.py         |   201 +-
 ...
 src/frob/perf/_cache_effects.py                    |   197 +
 ...
 src/frob/process/parsers/ruff.py                   |    10 -
 ...
 src/frob/strata/_host_isolation_vertical.py        |     1 -
 ...
 src/frob/strata/_mutation_audit.py                 |    66 +-
 ...
 src/frob/strata/_selfconform_surface_rules.py      |    43 +-
 ...
 src/frob/tickets/_evidence.py                      |   255 +-
 ...
 src/frob/tickets/_leases.py                        |   892 +-
 src/frob/tickets/_live_tracker.py                  |    42 +-
 src/frob/tickets/_models.py                        |   485 +-
 ...
 src/frob/tickets/_reconcile.py                     |     7 -
 ...
 src/frob/tickets/_store_migrate.py                 |    12 -
 ...
 src/frob/verify/_watermark.py                      |    18 -
 ...
 strata-core/src/parse/mod.rs                       |   370 +-
 ...
 tests/gates_suite/test_fix_engine.py               |   147 +
 ...
 tests/narrative/test_docarch002_fix.py             |   236 +
 ...
 tests/test_tickets_leases.py                       |    49 +-
 ...
 tests/unit/test_token_usage.py                     |   380 +
 ...
 tickets/T-4516/ticket.md                           |    60 +
 tickets/T-4518/done-report.md                      |  3294 +++
 tickets/T-4518/ticket.md                           |    64 +
 ...
 tickets/T-5137/done-report.md                      |  3776 ++++
 ...
 tickets/T-5274/ticket.md                           |    50 +
 tickets/T-5275/ticket.md                           |    49 +
 ...
 tickets/T-5308/ticket.md                           |    36 +
 tickets/T-5309/ticket.md                           |    36 +
 tickets/T-5310/ticket.md                           |   128 +
 tickets/T-5311/ticket.md                           |    36 +
 tickets/T-5312/ticket.md                           |   508 +
 tickets/T-5313/ticket.md                           |    36 +
 tickets/T-5314/ticket.md                           |    50 +
 tickets/T-5318/ticket.md                           |    37 +
 tickets/T-5321/ticket.md                           |    36 +
 tickets/T-5322/ticket.md                           |    36 +
 tickets/T-5323/ticket.md                           |    36 +
 tickets/T-5324/ticket.md                           |    38 +
 tickets/T-5325/ticket.md                           |    36 +
 tickets/T-5326/ticket.md                           |    36 +
 tickets/T-5327/ticket.md                           |    37 +
 tickets/T-5328/ticket.md                           |    34 +
 tickets/T-5329/ticket.md                           |    36 +
 tickets/T-5330/ticket.md                           |    65 +
 tickets/T-5331/ticket.md                           |    36 +
 tickets/T-5332/ticket.md                           |    36 +
 tickets/T-5333/ticket.md                           |    37 +
 tickets/T-5334/ticket.md                           |    36 +
 tickets/T-5335/ticket.md                           |    38 +
 tickets/T-5336/ticket.md                           |    38 +
 tickets/T-5337/ticket.md                           |    37 +
 tickets/T-5338/ticket.md                           |    66 +
 tickets/T-5339/ticket.md                           |    36 +
 ...
 uv.lock                                            |     2 +-
 3738 files changed, 492813 insertions(+), 22351 deletions(-)
```

### Evidence
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterDiscoverSessions::test_filters_by_worktree_and_window` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterDiscoverSessions::test_missing_telemetry_file_is_empty` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterExtractUsage::test_sums_assistant_usage_fields` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterExtractUsage::test_incremental_cursor_only_reads_new_bytes` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterExtractUsage::test_unreadable_transcript_is_incomplete_none_cursor` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestCollectTicketUsage::test_no_lease_returns_none` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestCollectTicketUsage::test_sums_assistant_usage_fields` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestCollectTicketUsage::test_session_without_transcript_path_marks_incomplete` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestRecordTicketUsage::test_writes_usage_onto_ticket` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestRecordTicketUsage::test_unknown_ticket_is_err` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestReleaseLeaseCollectsUsage::test_release_records_usage` (pytest node id, verified passing when recorded)
- `tests/test_hook_dispatch_telemetry.py::test_session_start_records_transcript_path_when_given` (pytest node id, verified passing when recorded)
- `tests/test_hook_dispatch_telemetry.py::test_session_start_omits_transcript_path_when_absent` (pytest node id, verified passing when recorded)
- `tests/unit/test_token_usage.py::TestClaudeCodeAdapterExtractUsage::test_budget_exceeded_stops_early_and_reports_incomplete` (pytest node id, verified passing when recorded)
