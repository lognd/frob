---
id: T-2650
title: 'post-land sweep regression from T-2629: 2 new (rule, file) identit(ies), 2
  finding(s) (DRIFT001, SEC004)'
state: dropped
kind: bug
origin: agent
created: '2026-08-19'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2629 at commit 798058028972e86d5dc04d5629fd9be7413a5548 found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
