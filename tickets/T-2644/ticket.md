---
id: T-2644
title: 'post-land sweep regression from T-2615: 1 new (rule, file) identit(ies), 1
  finding(s) (F401)'
state: queued
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2615 at commit 206fa3970818a4e2d92ead8f634cf24327800c58 found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
