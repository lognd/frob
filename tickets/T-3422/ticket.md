...
## Drop reason
- 2026-08-29: Resolved on main by T-3028 (93062a169): project-type misdetection caused CHECK001 to fire before the lease-pin refusal; the refusal text never changed (git log -S shows it introduced once in T-0787). Test passes 3x on current main.
