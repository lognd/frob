...
SEO121-126 close the ticket's crawl/discovery-config gap: robots.txt
had no malformed-line or Google-Extended decision-record check,
sitemap.xml had no schema validation, llms.txt had no presence
advisory, hreflang had no x-default check, and canonical links carrying
tracking query strings went unflagged. robots.txt/sitemap.xml checks
follow the ticket body's own framing (line-oriented text scan, stdlib
xml.etree.ElementTree) with no new grammar dependency; the canonical
check reuses T-5364's already-landed _seo_substrate.extract_page_
metadata unchanged. This worktree was kept plain per the coordinator's
instruction (no merge of t-5374/t-5365) so it lands cleanly on its own.
Same honest discovery-gap disclosure as the sibling SEO leaves:
websec_findings is not auto-discovered by any live gate today,
documented in the module and doc rather than faked. SEO127 is left
unimplemented and filed as T-5742. Fixtures live under their
own seo1xx/crawl/ subdir, separate from sibling tags/ and spam/
subdirs.
...
```
 ...
 src/frob/webapp/_seo_crawl.py                      |   431 +
 ...
 uv.lock                                            |   265 +-
 4560 files changed, 790599 insertions(+), 23544 deletions(-)
```

### Evidence
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo121_positive-SEO121-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo121_negative-SEO121-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo122_positive-SEO122-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo122_negative-SEO122-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo123_positive-SEO123-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo123_negative-SEO123-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo124_positive-SEO124-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo124_negative-SEO124-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo125_positive-SEO125-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo125_negative-SEO125-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo126_positive-SEO126-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_fixture[seo126_negative-SEO126-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_seo_crawl_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_websec_findings_emits_violation_when_called_directly` (pytest node id, verified passing when recorded)
- `tests/unit/test_seo_crawl.py::test_websec_findings_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
