---
id: T-3819
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3801):
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3801) at commit af0422a9347d120cb1d709ac14dae21b7e409abe found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
