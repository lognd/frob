...
LAUNCH101-107 close the ticket's pre-launch-checklist gap: team photo,
case studies, FAQ depth, thank-you page, sticky CTA, response-time
promise, and analytics presence had no advisory-only check. Confirmed
Severity.ADVISORY already existed (T-5304, git grep -n ADVISORY --
src/frob before writing any code) so this ticket only consumes it,
never widens frob.findings; the existing TestSeverityAdvisory fixture
already proves advisory never fails a gate, and this leaf's own test
suite asserts directly that every emitted Violation carries
Severity.ADVISORY, never WARN/ERROR. Checks write their own small local
presence sniffs rather than widening T-5360's RequiredPage enum (fixed
to PRIVACY/TERMS/ACCESSIBILITY) for seven unrelated marketing/UX
items. All seven reserved ids used, no follow-up filed.
...
```
 ...
 docs/modules/webapp-launch-checklist.md            |   110 +
 ...
 src/frob/webapp/_launch_checklist.py               |   380 +
 ...
 tests/unit/test_launch_checklist.py                |    88 +
 ...
 uv.lock                                            |   265 +-
 4570 files changed, 795541 insertions(+), 23553 deletions(-)
```

### Evidence
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch101_positive-LAUNCH101-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch101_negative-LAUNCH101-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch102_positive-LAUNCH102-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch102_negative-LAUNCH102-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch103_positive-LAUNCH103-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch103_negative-LAUNCH103-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch104_positive-LAUNCH104-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch104_negative-LAUNCH104-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch105_positive-LAUNCH105-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch105_negative-LAUNCH105-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch106_positive-LAUNCH106-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch106_negative-LAUNCH106-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch107_positive-LAUNCH107-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_fixture[launch107_negative-LAUNCH107-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_launch_checklist_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_websec_findings_emits_advisory_severity_never_warn_or_error` (pytest node id, verified passing when recorded)
- `tests/unit/test_launch_checklist.py::test_websec_findings_empty_frameworks_short_circuits` (pytest node id, verified passing when recorded)
