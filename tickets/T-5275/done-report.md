...
FMT002's lint half (frob.gates._fmt_directives.noqa_strip_violations)
and its Tier-A strip fix (frob.gates._fix_engine_text.fix_fmt002_noqa_strip)
shipped tested but unreachable since T-4714 -- neither run_gates nor
TIER_A_HANDLERS ever called them, so the rule silently never fired.
This ticket wires noqa_strip_violations into run_gates' self-check
violation set and registers fix_fmt002_noqa_strip in TIER_A_HANDLERS,
mirroring T-5274's own DSTACK001 wiring pattern landed just before it.
A new end-to-end positive control (through the real run_gates/
apply_tier_a_fixes entry points, not a direct leaf-function call) proves
the wiring fires and the fix is idempotent; the pre-existing closed-set
TIER_A_HANDLERS coverage test is extended with FMT002.
...
```
 ...
 src/frob/gates/__init__.py                         |   731 +-
 ...
 tests/gates_suite/test_fix_engine.py               |   280 +
 ...
 tickets/T-5300/ticket.md                           |   258 +
 tickets/T-5301/ticket.md                           |   158 +
 tickets/T-5302/ticket.md                           |   204 +
 tickets/T-5303/ticket.md                           |   292 +
 ...
 tickets/T-5349/ticket.md                           |    36 +
 tickets/T-5350/ticket.md                           |    36 +
 tickets/T-5351/ticket.md                           |    37 +
 tickets/T-5352/ticket.md                           |    37 +
 ...
 uv.lock                                            |     2 +-
 3783 files changed, 526026 insertions(+), 22657 deletions(-)
```

### Evidence
- `tests/gates_suite/test_fix_engine.py::TestFmt002Wiring::test_fmt002_fires_through_run_gates_and_fix_is_idempotent` (pytest node id, verified passing when recorded)
