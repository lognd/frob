---
id: T-3538
title: 'post-land sweep regression from an unattributed source (sweep spawned by T-3526):
  1 new (rule, file) identit(ies), 1 finding(s) (DOCENUM001)'
state: dropped
kind: bug
origin: agent
created: '2026-08-31'
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for an unattributed source (sweep spawned by T-3526) at commit 7fb25e371a9ef185fce140a4a3d022aeffa4c8e7 found 2 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
