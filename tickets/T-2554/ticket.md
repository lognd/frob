---
id: T-2554
title: 'post-land sweep regression from T-2374: 1 new (rule, file) identit(ies), 1
  finding(s) (E501)'
state: queued
kind: bug
origin: agent
...
land_commit: null
---
The deferred post-land unscoped sweep (T-1684) for T-2374 at commit f6504403e4e540fa8afda1e01f832cace77b16ef found 1 new (rule, file) identit(ies) that were not present in the previous sweep's baseline.
