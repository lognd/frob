...
- op: add
  ...
  at: '2026-08-30'
evidence:
- tests/unit/arch_suite/test_guards.py::TestComprehensionGuardOrdering::test_trailing_if_clause_discharges_its_own_leading_expression
- tests/unit/arch_suite/test_guards.py::TestComprehensionGuardOrdering::test_different_comprehension_ids_do_not_discharge
- tests/unit/arch_suite/test_guards.py::TestComprehensionGuardOrdering::test_comprehension_branch_does_not_discharge_a_non_comprehension_call
- tests/unit/arch_suite/test_guards.py::TestComprehensionGuardOrdering::test_real_proc_scan_corpus_site_has_no_leaked_value_error
- tests/unit/arch_suite/test_lang_adapters.py::TestPythonAdapter::test_adapt_tags_comprehension_branch_and_call_with_shared_id
