...
DOCARCH002's Tier-A handler (T-4694) reloaded the full ticket-archive YAML
once per finding and wrote ticket bodies as a side effect of an unrelated
ticket's land, wedging lands for 18-52 minutes (faulthandler traceback in
this ticket's own body); the coordinator hotfixed it out of TIER_A_HANDLERS.
Fixed by loading the archive exactly once per fix_docarch002_narrative_move
call and threading it down as a plain dict, gating every ticket-body write
behind merge_target_ids is None (T-2400's land-pre-land signal) so a land's
pre-land pass only ever plans moves and never writes a body, and adding an
only_paths scoping parameter matching the FMT001/FMT002 convention.
Re-registered in TIER_A_HANDLERS with a positive control: 50 findings across
10 files load the archive exactly once and make zero ledger writes when
merge_target_ids is given (pre-land mode), while a bare frob check --fix
...
```
 ...
 .../registry/capability-via-ratchet.lock.json      |   125 +-
 ...
 src/frob/gates/__init__.py                         |   726 +-
 ...
 src/frob/gates/_fix_engine.py                      |   547 +-
 ...
 tests/gates_suite/test_fix_engine.py               |   218 +
 ...
 tickets/T-5300/ticket.md                           |   257 +
 tickets/T-5301/ticket.md                           |   158 +
 tickets/T-5302/ticket.md                           |   204 +
 tickets/T-5303/ticket.md                           |   183 +
 tickets/T-5304/ticket.md                           |    44 +
 tickets/T-5305/ticket.md                           |    46 +
 tickets/T-5306/ticket.md                           |    43 +
 tickets/T-5307/ticket.md                           |    44 +
 tickets/T-5308/ticket.md                           |    43 +
 tickets/T-5309/ticket.md                           |    43 +
 tickets/T-5310/ticket.md                           |   128 +
 tickets/T-5311/ticket.md                           |    97 +
 tickets/T-5312/ticket.md                           |   508 +
 tickets/T-5313/ticket.md                           |    97 +
 tickets/T-5314/ticket.md                           |    50 +
 tickets/T-5318/ticket.md                           |    37 +
 tickets/T-5321/ticket.md                           |    97 +
 tickets/T-5322/ticket.md                           |    97 +
 tickets/T-5323/ticket.md                           |    97 +
 tickets/T-5324/ticket.md                           |    99 +
 tickets/T-5325/ticket.md                           |    97 +
 tickets/T-5326/ticket.md                           |    97 +
 tickets/T-5327/ticket.md                           |    37 +
 tickets/T-5328/ticket.md                           |    34 +
 tickets/T-5329/ticket.md                           |    97 +
 tickets/T-5330/ticket.md                           |    65 +
 tickets/T-5331/ticket.md                           |    43 +
 tickets/T-5332/ticket.md                           |    43 +
 tickets/T-5333/ticket.md                           |    44 +
 tickets/T-5334/ticket.md                           |    43 +
 tickets/T-5335/ticket.md                           |    45 +
 tickets/T-5336/ticket.md                           |    38 +
 tickets/T-5337/ticket.md                           |    44 +
 tickets/T-5338/ticket.md                           |    66 +
 tickets/T-5339/ticket.md                           |    43 +
 tickets/T-5340/ticket.md                           |    37 +
 tickets/T-5341/ticket.md                           |    37 +
 tickets/T-5342/ticket.md                           |    61 +
 tickets/T-5343/ticket.md                           |    34 +
 tickets/T-5344/ticket.md                           |    44 +
 tickets/T-5345/ticket.md                           |    38 +
 tickets/T-5347/done-report.md                      |  3773 +++
 tickets/T-5347/ticket.md                           |    57 +
 ...
 uv.lock                                            |     2 +-
 3754 files changed, 515895 insertions(+), 22394 deletions(-)
```

### Evidence
- `tests/narrative/test_docarch002_fix.py::TestDocarch002PreLandPlanOnly::test_archive_loaded_once_and_zero_ledger_writes_in_pre_land_mode` (pytest node id, verified passing when recorded)
- `tests/narrative/test_docarch002_fix.py::TestDocarch002PreLandPlanOnly::test_bare_check_fix_mode_still_writes` (pytest node id, verified passing when recorded)
