...
T-5309 adds frob.webapp._websec_deser, a WEBSEC109-116 code-injection
and unsafe-deserialization sink family reusing T-5307's sink-registry
shape. Per coordinator direction (T-5311 wiring), it does not hand-edit
frob.gates._taint_gate.py; instead it exposes the module-level
websec_findings(root, frameworks) -> tuple[Violation, ...] discovery
hook T-5311's taint_gate change auto-binds against, avoiding a lease
collision across the four sibling WEBSEC injection tickets landing
concurrently. Covers SSTI, eval/exec/new Function, unsafe yaml.load,
pickle deserialization, shell=True/os.system command injection, LDAP
filter concatenation, PyMongo NoSQL operator-key injection, and LaTeX
--shell-escape, each via Python AST (SEC005 substrate reuse) or a
scoped text-regex where no tree-sitter grammar applies. One positive
and one negative fixture per rule under
tests/fixtures/webapp/websec1xx/deser/, bound via frob:tests in
...
```
 ...
 src/frob/webapp/_websec_deser.py                   |   674 +
 ...
 tests/unit/test_websec_deser.py                    |   112 +
 ...
 tickets/T-5308/ticket.md                           |    65 +
 tickets/T-5309/ticket.md                           |   105 +
 tickets/T-5310/ticket.md                           |   128 +
 tickets/T-5311/ticket.md                           |   119 +
 ...
 uv.lock                                            |     2 +-
 4064 files changed, 645098 insertions(+), 23495 deletions(-)
```

### Evidence
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_no_framework_short_circuits` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc109_positive-WEBSEC109-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc109_negative-WEBSEC109-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc110_positive-WEBSEC110-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc110_negative-WEBSEC110-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc111_positive-WEBSEC111-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc111_negative-WEBSEC111-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc112_positive-WEBSEC112-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc112_negative-WEBSEC112-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc113_positive-WEBSEC113-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc113_negative-WEBSEC113-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc114_positive-WEBSEC114-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc114_negative-WEBSEC114-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc115_positive-WEBSEC115-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc115_negative-WEBSEC115-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc116_positive-WEBSEC116-True]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::test_websec_deser_findings_fixture[webesc116_negative-WEBSEC116-False]` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::TestWebsecFindingsGateHook::test_websec_findings_emits_violation` (pytest node id, verified passing when recorded)
- `tests/unit/test_websec_deser.py::TestWebsecFindingsGateHook::test_websec_findings_short_circuits_on_empty_frameworks` (pytest node id, verified passing when recorded)
