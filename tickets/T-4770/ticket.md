...
- src/frob/gates/_pii_structural/_node_index.py
- src/frob/gates/_pii_structural/_python_fields.py
...
evidence:
- cmd:python3 /tmp/claude-1000/-home-logan-projects-frob/a42444f0-d505-4990-88ee-806296379a83/scratchpad/verify_t4770_runs.py
  exit=0 sha256=178672a4e42b
- cmd:python3 /tmp/claude-1000/-home-logan-projects-frob/a42444f0-d505-4990-88ee-806296379a83/scratchpad/verify_t4770_narrative_moved.py
  exit=0 sha256=c3a697a507f9
- cmd:python3 /tmp/claude-1000/-home-logan-projects-frob/a42444f0-d505-4990-88ee-806296379a83/scratchpad/verify_t4770_no_ticket_blocks.py
  exit=0 sha256=2232c98d4eff
- cmd:sh /tmp/claude-1000/-home-logan-projects-frob/a42444f0-d505-4990-88ee-806296379a83/scratchpad/verify_t4770_nonbehavior.sh
  exit=0 sha256=c9f5ed3b1646
- cmd:/home/logan/projects/frob/.venv/bin/frob ticket list exit=0 sha256=51aab0adc42a
...
land_commit: null
---
CLUSTER leaf of T-4691 (C2). Scope-disjoint from every other cluster leaf;
...
MEASURED 2026-09-19 over src/frob/**/*.py (scratchpad/measure.py):
  20 files, 44 comment runs of 15+ consecutive `#` lines, 1019 lines.

PER-FILE:
    8 runs   197 lines  src/frob/gates/_wire.py
    5 runs   127 lines  src/frob/gates/_refs.py
    4 runs    92 lines  src/frob/gates/_secrets.py
    3 runs    81 lines  src/frob/gates/_protocol_summary.py
    3 runs    55 lines  src/frob/gates/_render_lint.py
    3 runs    50 lines  src/frob/gates/_rule_id_scan.py
    3 runs   105 lines  src/frob/gates/_waive_comments.py
    2 runs    55 lines  src/frob/gates/_pii_structural/_keywords.py
    2 runs    44 lines  src/frob/gates/_walk_lint.py
    1 runs    15 lines  src/frob/gates/_parse_failures.py
    1 runs    15 lines  src/frob/gates/_pii_structural/_node_index.py
    1 runs    19 lines  src/frob/gates/_pii_structural/_python_fields.py
    1 runs    20 lines  src/frob/gates/_profile_boundary.py
    1 runs    15 lines  src/frob/gates/_refs_schema.py
    1 runs    39 lines  src/frob/gates/_registry_exhaustiveness.py
    1 runs    16 lines  src/frob/gates/_sys_selfaudit.py
    1 runs    22 lines  src/frob/gates/_tdd_order.py
    1 runs    15 lines  src/frob/gates/_test_runner_schema.py
    1 runs    21 lines  src/frob/gates/_version_coupling.py
    1 runs    16 lines  src/frob/gates/invariants.py
