...
<!-- frob:describes src/frob/repo_meta.py::load_arch_config -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MAX_FUNCTION_LINES -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MAX_CLASS_METHODS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MAX_LOCAL_IMPORTS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MAX_NESTING_DEPTH -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MAX_FILE_LINES -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_LCOM4_MIN_METHODS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_LCOM4_MIN_FIELD_USING_METHODS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_GOD_MODULE_MIN_EXPORTS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_GOD_MODULE_MIN_CLUSTERS -->
<!-- frob:describes src/frob/repo_meta.py::ARCH_DEFAULT_MIXED_CONCERN_MIN_DECISION_POINTS -->
