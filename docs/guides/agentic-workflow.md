...
<!-- frob:describes src/frob/_cli_parsers/_ticket/_new.py::_add_ticket_new_parser -->
<!-- frob:describes src/frob/_cli_parsers/_ticket/_closeout.py::_add_ticket_attach_and_lifecycle_end_parsers -->
```bash
