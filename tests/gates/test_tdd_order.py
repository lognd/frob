...
class TestSymrefHelpers:
    # frob:ticket T-3009
    # frob:tests src/frob/gates/_tdd_order.py::symref_path
    ...
    # frob:ticket T-3009
    # frob:tests src/frob/gates/_tdd_order.py::symref_qualname
...
class TestAstQualnames:
    # frob:ticket T-3009
    # frob:tests src/frob/gates/_tdd_order.py::_ast_qualnames
...
class TestResolveSymbolIntroduction:
    # frob:ticket T-3009
    # frob:tests src/frob/gates/_tdd_order.py::resolve_symbol_introduction
...
class TestClassifyOrder:
    ...
    # frob:tests src/frob/gates/_tdd_order.py::TDDOrder
...
class TestPerfShape:
    ...
    # frob:ticket T-3618
    # frob:tests src/frob/gates/_tdd_order.py::_revisions_oldest_first
