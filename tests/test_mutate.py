...
# frob:tests src/frob/mutate/__init__.py::_PointCollector.visit_Compare kind="unit"
# frob:tests src/frob/mutate/__init__.py::_PointCollector.visit_Constant kind="unit"
# frob:tests src/frob/mutate/__init__.py::_PointCollector.visit_BoolOp kind="unit"
# frob:tests src/frob/mutate/__init__.py::_PointCollector.visit_BinOp kind="unit"
