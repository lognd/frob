# frob:waive SCOPE001 reason="T-0384's declared scope is src/frob/vet/+src/frob/strata/+docs/design/registry/weaknesses.yaml; tests/** is leased in-progress elsewhere so the scope cannot be formally extended here, same ad-hoc precedent as tests/test_check_coverage_registry.py's existing T-0424 SCOPE001 waiver and the sibling reconciliation pin tests (T-0385/T-0386/T-0387/T-0388)"  # noqa: E501
