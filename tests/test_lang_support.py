...
class TestDeriveLanguageRegistry:
    ...
    # frob:ticket T-0405
    # frob:ticket T-0406
    # frob:tests src/frob/lang/_support.py::derive_language_registry
    ...
    # frob:ticket T-3493
    def test_cuda_capability_dup_docblock_are_implemented(self) -> None:
        """T-3493: cuda registered a real `frob.lang` grammar/walker
        (T-1602) but was not wired into the three OTHER FACETS-axis
        subsystems -- real `LANGUAGES` entries in `frob.vet.
        _capability_registry`/`frob.dup._exhaustiveness` plus reuse of
        the existing c-cpp DOC004 bucket (`_C_CPP_LANGS`, cuda's own
        `#include` directives resolve the identical way) close the gap
        for real, not just via a reasoned KNOWN_GAP citation -- same
        shape as T-3492's java precedent above."""
        support = derive_language_registry()["cuda"]
        assert support.facets["capability"].state == FacetState.IMPLEMENTED
        assert support.facets["dup"].state == FacetState.IMPLEMENTED
        assert support.facets["docblock"].state == FacetState.IMPLEMENTED
        # frob.arch's multi-language dispatch is a separate, already
...
class TestConformanceViolations:
    ...
    # frob:ticket T-0405
    # frob:ticket T-0406
    # frob:tests src/frob/lang/_support.py::conformance_violations
    # frob:tests src/frob/lang/_support.py::LanguageSupport.missing_facets
    ...
    # frob:ticket T-0405
    # frob:ticket T-0406
    # frob:tests src/frob/lang/_support.py::_unreasoned_names
    # frob:tests src/frob/lang/_support.py::LanguageSupport.unreasoned_facets
...
class TestDeriveCapabilityRegistry:
    ...
    # frob:ticket T-2365
    # frob:tests src/frob/lang/_support.py::derive_capability_registry
    # frob:tests src/frob/lang/_support.py::AdapterCapabilitySupport
    def test_covers_every_supported_language(self) -> None:
...
class TestCapabilityConformanceViolations:
    ...
    # frob:ticket T-2365
    # frob:tests src/frob/lang/_support.py::capability_conformance_violations
    ...
    # frob:ticket T-2365
    # frob:tests src/frob/lang/_support.py::CapabilityRequirement
    # frob:tests src/frob/lang/_support.py::capability_conformance_violations
    # frob:tests src/frob/lang/_support.py::CapabilityStatus
    def test_fully_registered_language_passes(self) -> None:
        registry = {
            "fixture-lang": AdapterCapabilitySupport(
...
class TestPackageAudit:
    ...
    # frob:ticket T-2996
    # frob:tests src/frob/lang/_support.py::LANGUAGE_SENSITIVE_PACKAGES
    # frob:tests src/frob/lang/_support.py::PackageAudit
    # frob:tests src/frob/lang/_support.py::PackageLanguageAxis
    ...
    # frob:ticket T-2996
    # frob:tests src/frob/lang/_support.py::unfaceted_packages
...
# frob:ticket T-2996
# frob:tests src/frob/lang/_support.py::_REFACTOR_ADAPTER_LANGUAGES
