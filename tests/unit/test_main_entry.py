...
class TestHelpListsDirectDispatchVerbs:
    ...
    # frob:tests src/frob/_cli_parsers/_root.py::_add_analysis_subparsers
...
class TestIsRealVenv:
    ...
    # frob:tests src/frob/__main__.py::_is_real_venv
...
class TestVerboseFlag:
    ...
    # frob:tests src/frob/__main__.py::_apply_verbose_env_override
