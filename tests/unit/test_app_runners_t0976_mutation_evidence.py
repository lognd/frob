...
class TestCollectStacksViaSamplerArgvStripping:
    ...
    # frob:tests src/frob/app/perf_runner.py::_collect_stacks_via_sampler
...
class TestRenderDoableDispatchableByParentGrouping:
    ...
    # frob:tests src/frob/app/ticket_runner/_query.py::_render_doable_dispatchable
...
class TestCloseGuardsMutationEvidenceDowngrade:
    ...
    # frob:tests src/frob/app/ticket_runner/_close_cmd.py::_close_guards_for_ticket
