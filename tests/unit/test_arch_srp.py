...
class TestLcom4:
    ...
    # frob:tests src/frob/arch/_srp.py::check_lcom4
...
class TestMixedConcernFunction:
    ...
    # frob:tests src/frob/arch/_srp.py::check_mixed_concern_function
...
class TestRunSrpChecks:
    ...
    # frob:tests src/frob/arch/_srp.py::run_srp_checks
...
class TestAnalyzeProjectWiring:
    ...
    # frob:tests src/frob/arch/__init__.py::_run_srp_checks_python
