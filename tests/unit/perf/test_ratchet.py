...
class TestPersistRoundTrip:
    # frob:tests src/frob/perf/_ratchet.py::load_ratchet_findings
    """`save_ratchet_findings`/`load_ratchet_findings` round trip."""

    # frob:tests src/frob/perf/_ratchet.py::save_ratchet_findings
    # frob:tests src/frob/perf/_ratchet.py::load_ratchet_findings
...
class TestRatchetViolations:
    ...
    # frob:tests src/frob/perf/_ratchet.py::ratchet_violations
