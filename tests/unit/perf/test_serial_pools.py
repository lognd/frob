...
class TestStackSamplerAllThreads:
    ...
    # frob:tests src/frob/perf/_sampler.py::StackSampler.start
...
class TestSerialExecutor:
    ...
    # frob:tests src/frob/perf/_serial_pools.py::SerialExecutor.submit
    ...
    # frob:tests src/frob/perf/_serial_pools.py::SerialExecutor.map
    ...
    # frob:tests src/frob/perf/_serial_pools.py::SerialExecutor.shutdown
...
class TestInstallSerialPools:
    ...
    # frob:tests src/frob/perf/_serial_pools.py::install_serial_pools
