...
class TestExternalCallAdvisories:
    # frob:tests src/frob/perf/_advisories.py::external_call_advisories
...
# frob:tests src/frob/perf/_advisories.py::nested_loop_fanin_advisories
...
class TestHeavyTailAdvisories:
    # frob:tests src/frob/perf/_advisories.py::heavy_tail_advisories
