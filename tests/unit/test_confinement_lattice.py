...
class TestConfinementLatticePositiveControl:
    ...
    # frob:tests src/frob/graph/summary.py::scan_confinement_facts
    # frob:tests src/frob/graph/summary.py::FsWriteSite
    # frob:tests src/frob/graph/summary.py::ConfinementState
    ...
    # frob:tests src/frob/graph/summary.py::ConfinementCensusResult
...
class TestConfinementLatticeUnknown:
    ...
    # frob:tests src/frob/graph/summary.py::compute_confinement_summaries
...
class TestConfinementLatticeHelperPropagation:
    ...
    # frob:tests src/frob/graph/summary.py::compute_confinement_summaries
    # frob:tests src/frob/graph/summary.py::FunctionConfinement
...
class TestParam0Credit:
    ...
    # frob:tests src/frob/graph/summary.py::_compute_param0_credit
