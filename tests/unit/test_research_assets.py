...
# frob:waive DUP001 reason="deliberate mirror of frob.graph.dsl.slugify for test \
# isolation (see docstring below); waived at the production site with the same \
# reasoning"
