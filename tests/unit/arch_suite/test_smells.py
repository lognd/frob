...
class TestMutableDefaultArg:
    ...
    # frob:tests src/frob/arch/_smells.py::check_mutable_default_arg
...
class TestDataClumps:
    ...
    # frob:tests src/frob/arch/_smells.py::check_data_clumps
...
class TestMagicLiteral:
    ...
    # frob:tests src/frob/arch/_smells.py::check_magic_literal
...
class TestDeadPrivateCode:
    ...
    # frob:tests src/frob/arch/_smells.py::check_dead_private_code
...
class TestDeepInheritance:
    ...
    # frob:tests src/frob/arch/_smells.py::check_deep_inheritance
...
class TestTemporalCoupling:
    ...
    # frob:tests src/frob/arch/_smells.py::check_temporal_coupling
...
class TestRunSmellChecks:
    ...
    # frob:tests src/frob/arch/_smells.py::run_smell_checks
