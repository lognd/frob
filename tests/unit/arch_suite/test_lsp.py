...
class TestOverrideRaisesNotImplemented:
    ...
    # frob:tests src/frob/arch/_solid.py::check_override_raises_not_implemented
...
class TestOverrideStrengthenedPrecondition:
    ...
    # frob:tests src/frob/arch/_solid.py::check_override_strengthened_precondition
...
class TestOverrideWeakenedPostcondition:
    ...
    # frob:tests src/frob/arch/_solid.py::check_override_weakened_postcondition
...
class TestNoOpOverride:
    ...
    # frob:tests src/frob/arch/_solid.py::check_noop_override
...
class TestRunLspChecks:
    ...
    # frob:tests src/frob/arch/_solid.py::run_lsp_checks
...
class TestFatInterface:
    ...
    # frob:tests src/frob/arch/_solid.py::check_fat_interface
...
class TestNarrowClientUsage:
    ...
    # frob:tests src/frob/arch/_solid.py::check_narrow_client_usage
...
class TestRunIspChecks:
    ...
    # frob:tests src/frob/arch/_solid.py::run_isp_checks
