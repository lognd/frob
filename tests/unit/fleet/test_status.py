...
class TestCollectStatus:
    ...
    def test_git_branch_and_dirty_kill_switch_refuses_without_spawning(
        ...
        # frob:tests \
        # tests/unit/fleet/test_status.py::TestCollectStatus.test_git_branch_and_dirty_kill_switch_refuses_without_spawning  # noqa: E501
    ...
    def test_gate_summary_probe_kill_switch_refuses_without_spawning(
        ...
        # frob:tests \
        # tests/unit/fleet/test_status.py::TestCollectStatus.test_gate_summary_probe_kill_switch_refuses_without_spawning  # noqa: E501
