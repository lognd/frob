...
# frob:ticket T-2257
# frob:waive WIRE001 follow_up="T-3504" reason="private test-fixture helper used only \
...
# per-file test helper -- follow_up points at T-3504, this repo's established shared \
