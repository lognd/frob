...
# frob:waive OPAQUE001 reason="T-1427: every setattr(...) here is pytest monkeypatch \
# test isolation, reassigning a module attribute by a name this test file itself \
# spells out as a literal -- the two genuine external boundaries BUG002 crosses (a git \
# worktree checkout and a pytest subprocess) plus TEST016 sibling guard. Deliberate \
# test infrastructure over closed, statically-written targets, not dynamic attribute \
# access over untrusted input"
