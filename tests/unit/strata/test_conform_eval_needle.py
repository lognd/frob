...
class TestEvalNeedleSelfMatch:
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_identifier_suffix_does_not_fire_eval  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_identifier_suffix_does_not_fire_sys100  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_genuine_bare_eval_call_still_fires  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_genuine_bare_exec_call_still_fires  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_identifier_suffix_for_exec_does_not_fire  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_conform_eval_needle.py::TestEvalNeedleSelfMatch.test_real_repo_design_selfconform_has_no_eval_gap  # noqa: E501
