...
class TestShrinkReportDropsStaleGrants:
    ...
    # frob:tests src/frob/strata/_shrink.py::ShrinkDrop kind="unit"
    # frob:tests src/frob/strata/_shrink.py::shrink_report kind="unit"
    ...
    # frob:tests src/frob/strata/_shrink.py::ShrinkReport.has_drift kind="unit"
    # frob:tests src/frob/strata/_shrink.py::ShrinkReport kind="unit"
    ...
    # frob:tests src/frob/strata/_shrink.py::PartialStaleSkip kind="unit"
    ...
    # frob:tests src/frob/strata/_shrink.py::apply_shrink kind="unit"
    # frob:tests src/frob/strata/_shrink.py::FileShrinkResult.changed kind="unit"
    # frob:tests src/frob/strata/_shrink.py::FileShrinkResult kind="unit"
