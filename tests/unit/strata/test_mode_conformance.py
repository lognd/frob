...
class TestCheckModeConformance:
    ...
    # frob:tests src/frob/strata/_mode_conformance.py::check_mode_conformance
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_read_mode_discharges_on_read_only_code  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_append_mode_fails_on_a_truncating_write  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_append_mode_discharges_on_an_append_only_open  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_exclusive_mode_fails_on_access_outside_the_arbiter  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_exclusive_mode_discharges_inside_the_declared_lock  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_exclusive_mode_with_no_lock_declared_fails_closed  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_alpha_mode_fails_on_an_unguarded_write  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_write_mode_is_unrestricted_in_v0  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_write_mode_fails_outside_the_declared_path  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_write_mode_with_no_extractable_literal_stays_silent  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_exclusive_mode_discharges_through_an_arbitrated_by_node  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_exclusive_mode_fails_when_arbitrated_by_node_never_called  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_alpha_mode_fires_reacquire_deadlock_alongside_the_guarded_pass  # noqa: E501
    def test_alpha_mode_fires_reacquire_deadlock_alongside_the_guarded_pass(
        self, tmp_path: Path
    ):
        """Proves a write nested inside two `with db_lock:` blocks (the
        same lock reacquired) fires `alpha_reacquire_deadlock`: it is
        lexically inside a with-block naming the lock, so a lock-name
        check alone calls it conformant, yet it is the upgrade-deadlock
        anti-pattern this category exists to catch (see T-1060)."""
        _write(
            tmp_path,
            "upgrader/main.py",
            "with db_lock:\n"
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_alpha_mode_single_lock_context_does_not_fire_reacquire_deadlock  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_node_with_no_access_declarations_is_never_checked  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mode_conformance.py::TestCheckModeConformance.test_a_waived_sys205_finding_is_discharged_and_reported_waived  # noqa: E501
