...
class TestOutboundDestinationConstraint:
    ...
    # kind="unit"
    # frob:tests src/frob/strata/_outbound_destination.py::OutboundDestinationViolation
    # frob:tests src/frob/strata/_outbound_destination.py::OutboundDestinationReport
