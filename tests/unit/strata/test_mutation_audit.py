...
class TestMayMutationAuditRealRepo:
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestMayMutationAuditRealRepo.test_baseline_sys101_is_zero  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestMayMutationAuditRealRepo.test_no_undetectable_kinds  # noqa: E501
    ...
    # frob:tests src/frob/strata/_mutation_audit.py::run_may_mutation_audit kind="unit"
    # frob:tests \
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestMayMutationAuditRealRepo.test_second_detector_gaps_are_exactly_the_disclosed_app_level_kinds  # noqa: E501
    # frob:ticket T-1328
...
class TestDetectableKindsVocabulary:
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestDetectableKindsVocabulary.test_wired_tier2_kinds_are_detectable  # noqa: E501
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestDetectableKindsVocabulary.test_proc_family_is_currently_undetectable  # noqa: E501
...
class TestNodeAllowedAppCapabilities:
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestNodeAllowedAppCapabilities.test_differs_when_atom_removed  # noqa: E501
    # frob:ticket T-1328
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestNodeAllowedAppCapabilities.test_bare_env_covers_both_modes  # noqa: E501
    # frob:ticket T-1328
    ...
    # frob:tests \
    # tests/unit/strata/test_mutation_audit.py::TestNodeAllowedAppCapabilities.test_unknown_kind_allows_nothing  # noqa: E501
    # frob:ticket T-1328
