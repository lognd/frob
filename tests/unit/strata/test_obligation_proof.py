...
# frob:waive PII012 reason="'token' here is files_evidence_token's own lexical-match \
# vocabulary (grep for a regex token in a file), not a credential/auth token -- a \
# name-signature false positive; surfaced (not introduced) by T-0988's mechanical \
