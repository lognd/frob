...
# frob:waive PERF004 reason="one sort per adjacency list to make BFS traversal order \
# deterministic, not resorted per iteration; oracle only runs over \
# hypothesis-generated small graphs"
def _bfs_oracle(
    nodes: tuple[str, ...],
    edges: list[tuple[str, str, str, bool, bool]],
    src: str,
...
# frob:waive PERF003 reason="dict/set comprehensions over the oracle output plus a \
# real BFS-walk loop, over hypothesis-generated small graphs; not a cross join"
