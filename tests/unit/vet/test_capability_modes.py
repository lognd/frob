...
class TestModeQualified:
    # frob:tests src/frob/vet/_capability_modes.py::_mode_qualified kind="unit"
...
class TestExpandDeclaredKind:
    ...
    # frob:tests src/frob/vet/_capability_modes.py::expand_declared_kind kind="unit"
...
class TestResolveCapabilityKind:
    # frob:tests src/frob/vet/_capability_modes.py::resolve_capability_kind kind="unit"
    ...
    # frob:tests src/frob/vet/_capability_modes.py::CapabilityModeError kind="unit"
...
class TestCanonicalAndNormalize:
    # frob:tests src/frob/vet/_capability_modes.py::canonical_declared_kind kind="unit"
    ...
    # frob:tests src/frob/vet/_capability_modes.py::_normalize_observed_kind kind="unit"
