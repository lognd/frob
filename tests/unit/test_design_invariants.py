...
class TestInv007:
    ...
    # frob:tests src/frob/gates/_design_invariants.py::inv007_violations
    # frob:tests src/frob/arch/_normalized.py
...
"""
    ...
    # frob:tests src/frob/gates/_design_invariants.py::inv011_violations
