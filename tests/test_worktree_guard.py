...
class TestApplyAgentEnv:
    ...
    # frob:tests src/frob/tickets/_worktree_guard.py::apply_agent_env
...
class TestWarnIfXdistBoundMissing:
    ...
    # frob:tests src/frob/tickets/_worktree_guard.py::warn_if_xdist_bound_missing
...
class TestAddoptsSetsXdist:
    ...
    # frob:ticket T-3722
    # frob:tests src/frob/tickets/_worktree_guard.py::_addopts_sets_xdist
...
class TestWarnIfXdistPluginMissing:
    ...
    # frob:ticket T-3316
    # frob:ticket T-3722
    # frob:tests src/frob/tickets/_worktree_guard.py::warn_if_xdist_plugin_missing
    # frob:tests src/frob/tickets/_worktree_guard.py::_xdist_plugin_present
...
class TestWarnIfTestmonPluginMissing:
    ...
    # frob:ticket T-3401
    # frob:tests src/frob/tickets/_worktree_guard.py::warn_if_testmon_plugin_missing
    # frob:tests src/frob/tickets/_worktree_guard.py::_testmon_plugin_present
    def test_must_fire_when_plugin_not_importable(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
