...
class TestDoneReportClaimsModel:
    ...
    # frob:tests src/frob/tickets/_models.py::parse_claims_from_done_report kind="unit"
    # frob:tests src/frob/tickets/_models.py::render_claims_block kind="unit"
    ...
    # frob:tests src/frob/tickets/_models.py::parse_claims_from_done_report kind="unit"
    # frob:tests src/frob/tickets/_models.py::render_claims_block kind="unit"
    # frob:tests src/frob/tickets/_models.py::DoneReportClaims kind="unit"
