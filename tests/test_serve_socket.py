...
class TestSocketPath:
    ...
    # frob:tests src/frob/serve/_socketd.py::socket_path kind="unit"
...
# frob:tests src/frob/serve/_socketd.py::acquire_singleton_lock kind="unit"
...
class TestDispatchRequest:
    ...
    # src/frob/serve/_socketd.py::dispatch_request frob:tests \
    ...
    # frob:tests src/frob/serve/_socketd.py::_RequestHandler._handle_version kind="unit"
    @pytest.mark.skipif(
        sys.platform == "win32",
        reason=(
...
class TestRunSocketDaemon:
    # frob:tests src/frob/serve/_socketd.py::socket_path kind="unit"
    # frob:tests src/frob/serve/_socketd.py::send_request kind="unit"
    # frob:tests src/frob/serve/_socketd.py::run_socket_daemon kind="unit"
    # frob:tests src/frob/serve/_socketd.py::_RequestHandler.handle kind="unit"
    # frob:tests src/frob/serve/_socketd.py::_IdleTracker.idle_for_s kind="unit"
    @pytest.mark.skipif(
        sys.platform == "win32",
        reason=(
            "T-2961: the daemon's unix-socket transport (socketserver."
...
class TestReapMultiprocessingChildren:
    ...
    # frob:tests src/frob/serve/_socketd.py::_reap_multiprocessing_children
