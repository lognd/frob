...
# frob:tests src/frob/mutate/_journal.py::remove_journal frob:tests \
# src/frob/mutate/_journal.py::remove_journal frob:tests \
# src/frob/mutate/_journal.py::remove_journal \
