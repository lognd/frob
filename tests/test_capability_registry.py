...
_FIRE_FIXTURES: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("python", "net-connect", "m.py", "import socket\nsocket.socket()\n"),
    ("python", "fs-write", "m.py", "open('x', 'w').write('y')\n"),
    ("python", "env-read", "m.py", "import os\nos.environ.get('X')\n"),
    ...
    ("typescript", "net-connect", "m.ts", "const ws = new WebSocket(url)\n"),
    ("typescript", "env-read", "m.ts", "process.env.SECRET\n"),
