...
# frob:tests src/frob/lang/_models.py::GRAMMAR_FINGERPRINT_PACKAGES
...
class TestResolve:
    ...
    # frob:tests src/frob/graph/_models.py::GraphError
...
class TestGeneratedSource:
    ...
    # frob:tests src/frob/graph/_generated.py::is_generated_source
...
class TestCallGraph:
    ...
    def test_build_call_graph_resolved_private_callee_is_not_also_unresolved(
        ...
        call_graph = build_call_graph(tmp_path, ("src/a.py",), mark_unresolved=True)
        assert call_graph.calls == {"src/a.py::public_entry": ("src/a.py::_helper",)}
        # frob:tests src/frob/graph/callgraph.py::_unresolved_exempt_names
