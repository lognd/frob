...
class TestTreeDigest:
    # frob:tests src/frob/testing/_coverage_wait.py::tree_digest kind="unit"
...
class TestSharedStateDir:
    # frob:tests src/frob/testing/_coverage_wait.py::shared_state_dir kind="unit"
...
class TestWorktreeLock:
    ...
    # frob:tests src/frob/testing/_coverage_wait.py::_worktree_lock kind="unit"
...
class TestCoverageLockPlatformBackends:
    """T-2952: `_flock_path`'s msvcrt (Windows) backend and its loud
    refusal when neither `fcntl` nor `msvcrt` exists -- the same
