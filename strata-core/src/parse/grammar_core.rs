...
// frob:debt LARGE001 reason="T-3044 added parse_vmodel_node/parse_vmodel_edge (V-model H3 \
// grammar), pushing this file from ~795 to 827 lines against the 800-line threshold" \
// ticket="T-3260"
// frob:waive LARGE001 reason="tracked real-split follow-up, T-3260 -- splitting \
// parse_vmodel_node/parse_vmodel_edge out is too large to do as a drive-by in a mixed-gate \
// cleanup slice"
// ---------------------------------------------------------------------
// Parser
// ---------------------------------------------------------------------
