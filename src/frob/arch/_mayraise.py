...
in `frob.arch._mayraise_tables` (T-3627), and never folded into a
`FunctionMayRaise.raises` set -- per the
...
from frob.arch._mayraise_tables import (
    _BUILTIN_RAISERS,
    _EXCEPTION_PARENT,
    _STDLIB_QUALIFIED_RAISERS,
    _SUBSCRIPT_RAISE,
    UNKNOWN,
)
