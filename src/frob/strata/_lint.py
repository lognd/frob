...
# src/frob/strata/_lint.py's exclusivity-vocabulary hit is source-level \
...
# with _lint005_violation below; distinct rule ids, fields (service vs \
# headroom), and messages -- structural coincidence, not shared logic"
...
# frob:waive DUP001 reason="Violation-builder boilerplate shared shape \
# with _lint002_violation above; distinct rule id and fields -- structural \
# coincidence, not shared logic"
