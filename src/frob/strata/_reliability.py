...
# (the demoted case). T-1062: leaked Unknown traces to _TIMEOUT_TOKEN_RE.search(text), \
...
# frob:waive EXHAUST003 reason="T-1402: EXHAUST001 narrowed to fire for an own \
# ambiguous bare re-raise; this leaked Unknown traces to an unresolved callee instead \
# (the demoted case). T-1062: leaked Unknown traces to _HEALTH_TOKEN_RE.search(text), \
# a compiled-regex search over an already-decoded str produced by the caught \
# read_text() call; a compiled pattern search cannot raise"
