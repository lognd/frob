...
# frob:ticket T-0562
# frob:waive ARCH103 reason="T-0977: report-and-exit CLI helper -- its one job is \
# rendering `mismatches` in the caller's chosen format (text vs json) and setting the \
# exit code; the json/text branch IS the reporting concern, not a separate one to \
# extract"
