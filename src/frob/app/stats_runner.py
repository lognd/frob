...
# src/frob/app/stats_runner.py's \
# exclusivity-vocabulary hits are source-level design-rationale prose \
# (a header string and docstring describing already-implemented proxy \
# behavior added by T-1127, verifiable by reading the code they \
# annotate) rather than a separate cross-module contract needing its \
# own tracked invariant; disposed as a calibration batch, not \
# claim-by-claim"
