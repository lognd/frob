...
_EVASION_LITMUS_MAP: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("python", "runtime"): (
        ...
        "TestOpaqueIndirectionGate.test_python_functools_partial_dynamic_target_not_addressed",
        "TestOpaqueIndirectionGate.test_python_dunder_getattr_class_interception_not_addressed",
        "TestOpaqueIndirectionGate.test_python_sys_modules_replacement_not_addressed",
    ),
    ("typescript", "static"): (
    ...
    ("typescript", "runtime"): (
        ...
        "TestOpaqueIndirectionGate.test_typescript_global_this_bracket_not_addressed",
        "TestOpaqueIndirectionGate.test_typescript_reflect_apply_dynamic_target_not_addressed",
        ...
        "TestOpaqueIndirectionGate.test_typescript_proxy_interception_not_addressed",
        "TestOpaqueIndirectionGate.test_typescript_container_dynamic_key_not_addressed",
        "TestOpaqueIndirectionGate.test_typescript_monkeypatch_module_namespace_not_addressed",
    ),
    ("rust", "static"): (
    ...
    ("rust", "runtime"): (
        ...
        "TestOpaqueIndirectionGate.test_rust_extern_ffi_symbol_not_addressed",
        "TestOpaqueIndirectionGate.test_rust_libloading_get_fires_only_when_file_uses_libloading",
        "TestOpaqueIndirectionGate.test_rust_function_pointer_in_container_not_addressed",
        "TestOpaqueIndirectionGate.test_rust_boxed_dyn_fn_runtime_selected_not_addressed",
        "TestOpaqueIndirectionGate.test_rust_proc_macro_synthesized_call_not_addressed",
    ),
    ("c", "static"): (
    ...
    ("cpp", "runtime"): (
        ...
        "TestOpaqueIndirectionGate.test_c_dlsym_non_literal_symbol_fires",
        "TestOpaqueIndirectionGate.test_cpp_reinterpret_cast_to_function_pointer_not_addressed",
        "TestOpaqueIndirectionGate.test_cpp_rtti_driven_dispatch_not_addressed",
    ),
    ("kotlin", "static"): (
    ...
    ("kotlin", "runtime"): (
        ...
        "TestOpaqueIndirectionGate.test_kotlin_function_value_in_container_not_addressed",
        "TestOpaqueIndirectionGate.test_kotlin_delegated_property_by_not_addressed",
        "TestOpaqueIndirectionGate.test_kotlin_dynamic_classloading_not_addressed",
    ),
}
