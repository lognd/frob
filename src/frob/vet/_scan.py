...
# T-1420 LARGE001 split: the per-rule Violation-constructor family
# (VET001/002/003/004/006/011 + the quarantine check + `_lockfile_name`)
# moved verbatim to `_scan_violations.py` (see that module's docstring for
# the seam rationale); re-exported here so every existing
# `from frob.vet._scan import _vetNNN_violation` caller keeps working
# unchanged.
from frob.vet._scan_violations import (  # noqa: E402
    _lockfile_name as _lockfile_name,
)
from frob.vet._scan_violations import (  # noqa: E402
    _quarantine_violation as _quarantine_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet001_violation as _vet001_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet002_violation as _vet002_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet003_violation as _vet003_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet004_violation as _vet004_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet006_violation as _vet006_violation,
)
from frob.vet._scan_violations import (  # noqa: E402
    _vet011_violation as _vet011_violation,
)
