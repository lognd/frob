...
path.
"""
# frob:waive INV006 reason="T-0712: this module's 'only' usage \
# ('WARN-only') is source-level design-rationale prose describing already-\
# implemented internal behavior (verifiable by reading the Violation(severity=\
# Severity.WARN, ...) calls below), not a separate cross-module contract \
