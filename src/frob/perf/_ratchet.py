...
posture.
"""
# frob:waive INV006 reason="T-0712: this module's 'only' usage ('today's \
# only producer') is source-level design-rationale prose describing already-\
# implemented internal behavior (verifiable by reading frob.app.perf_runner's \
# _persist_run, the sole current caller), not a separate cross-module contract \
# needing its own tracked invariant; same calibration-batch disposition as \
# the T-0585/T-0711 INV006 pool"
