...
#: T-2906: bash and csharp added (T-1604/T-1600's grammars) -- every cell
#: for both is generated by `_non_python_excuses` below like every other
#: non-python language, no hand-written claim needed to close this gap.
#: T-3492: java added (T-1601's grammar), same shape.
#: T-3493: cuda added (T-1602's grammar), same shape.
LANGUAGES: tuple[str, ...] = (
    "python",
    "typescript",
    "rust",
