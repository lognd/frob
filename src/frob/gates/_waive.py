...
_KNOWN_GATE_RULES = frozenset(
    {
        ...
        "NATIVESCHEMA001",
        # frob:ticket T-2430
        # T-2390 epic child: PROFILESCHEMA001 -- an unknown/misspelled key
        # in the [profile] table (frob.gates._profile_schema).
        "PROFILESCHEMA001",
        # frob:ticket T-2431
        ...
        "ARCHSCHEMA001",
        # frob:ticket T-2434
        # T-2390 epic child: DOCBLOCKSSCHEMA001 -- an unknown/misspelled
        # key in a [[docblocks.commands]] entry (frob.gates._docblocks_schema).
        "DOCBLOCKSSCHEMA001",
        # frob:ticket T-2388
        ...
        "GATES001",
        # T-4951: strata `forbid call` / `forbid import` wired into the
        # built-in analyzable check (FORBID001-003).
        "FORBID001",
        "FORBID002",
        "FORBID003",
        ...
        "WRAP002",
        "WRAP003",
        # T-5301 (T-WEBSUB-3 leaf of the T-5140 web-app-lint epic): reserved
        # rule-id block for the seven web-app-lint families -- NONE of
        # these rules are implemented yet (no check emits any of these
        # ids today); each is a placeholder so `frob:waive <id> reason=...`
        # on a not-yet-shipped id round-trips through the known-rule-id
        # check instead of failing loud with UnknownRuleId, exactly like
        # PERF015-018's T-5136 reservation before those rules existed.
        # WEBSEC101-125: T-5141 (injection/output-encoding). WEBSEC201-230:
        # T-5142 (session/auth/crypto). WEBSEC301-334: T-5143
        # (config/headers/supply-chain). WEBSEC401-419: T-5144
        # (authz/business-logic/LLM). COMPLY101-127: T-5145 (required
        # pages/disclosures). A11Y101-135: T-5146 (WCAG 2.2 A/AA).
        # SEO101-127: T-5147 (search/markup). WEBPERF101-115: T-5147
        # (Core Web Vitals markup/server). SQL101-130: T-5148 (sqlfluff/
        # ORM/migration rules). LAUNCH101-107: T-5145-6 (advisory-only
        # pre-launch checklist, never errors -- see [gates.severity]
        # below, Severity.ADVISORY per T-5304). Each id above will be
        # replaced by a real check as its own story leaf lands (T-5140's
        # decomposition tree).
        "WEBSEC101",
        "WEBSEC102",
        "WEBSEC103",
