...
# frob:tests tests/gates_suite/test_invariant.py::TestExcludeHazardGate.test_entry_shadowing_tracked_dir_fires  # noqa: E501
# frob:tests tests/gates_suite/test_invariant.py::TestExcludeHazardGate.test_entry_matching_no_tracked_path_is_silent  # noqa: E501
