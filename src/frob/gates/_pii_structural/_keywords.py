...
_PII012_REVIEWED_NON_PII: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        ("tests/gates_suite/test_compliance.py", "token"),
        ...
        (
            ...
            "test_rust_secret_newtype_type_field_fires",
        ),
        ("tests/gates_suite/test_compliance.py", "test_rust_struct_ssn_field_fires"),
        (
            "tests/gates_suite/test_compliance.py",
            "test_ts_branded_email_type_field_fires",
        ),
        ("tests/gates_suite/test_compliance.py", "test_ts_class_field_token_fires"),
        ("tests/gates_suite/test_compliance.py", "test_ts_interface_email_field_fires"),
        (
            "tests/gates_suite/test_compliance.py",
            "test_ts_secret_wrapper_type_field_fires",
        ),
        (
            "tests/gates_suite/test_compliance.py",
            "test_ts_type_alias_password_field_fires",
        ),
